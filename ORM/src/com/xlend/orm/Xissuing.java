// Generated by com.xlend.orm.tools.dbgen.DbGenerator.class at Mon Mar 19 19:46:08 EET 2012
...
public class Xissuing extends DbObject  {
    ...
    private Date day1Start = null;
    private Date day1End = null;
    private Date day2Start = null;
    private Date day2End = null;
    private Date day3Start = null;
    private Date day3End = null;
    private Date day4Start = null;
    private Date day4End = null;
    private Date day5Start = null;
    private Date day5End = null;
    private Date day6Start = null;
    private Date day6End = null;
    private Date day7Start = null;
    private Date day7End = null;
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xissuing_id,issueddate,operator_id,xmachine_id,xsite_id,day1_start,day1_end,day2_start,day2_end,day3_start,day3_end,day4_start,day4_end,day5_start,day5_end,day6_start,day6_end,day7_start,day7_end,time1_start,time1_end,time2_start,time2_end,time3_start,time3_end,time4_start,time4_end,time5_start,time5_end,time6_start,time6_end,time7_start,time7_end,hours1_start,hours1_end,hours2_start,hours2_end,hours3_start,hours3_end,hours4_start,hours4_end,hours5_start,hours5_end,hours6_start,hours6_end,hours7_start,hours7_end,liters1_start,liters1_end,liters2_start,liters2_end,liters3_start,liters3_end,liters4_start,liters4_end,liters5_start,liters5_end,liters6_start,liters6_end,liters7_start,liters7_end,issuedby1_start,issuedby1_end,issuedby2_start,issuedby2_end,issuedby3_start,issuedby3_end,issuedby4_start,issuedby4_end,issuedby5_start,issuedby5_end,issuedby6_start,issuedby6_end,issuedby7_start,issuedby7_end FROM xissuing WHERE xissuing_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xissuing.setDay1Start(rs.getDate(6));
                xissuing.setDay1End(rs.getDate(7));
                xissuing.setDay2Start(rs.getDate(8));
                xissuing.setDay2End(rs.getDate(9));
                xissuing.setDay3Start(rs.getDate(10));
                xissuing.setDay3End(rs.getDate(11));
                xissuing.setDay4Start(rs.getDate(12));
                xissuing.setDay4End(rs.getDate(13));
                xissuing.setDay5Start(rs.getDate(14));
                xissuing.setDay5End(rs.getDate(15));
                xissuing.setDay6Start(rs.getDate(16));
                xissuing.setDay6End(rs.getDate(17));
                xissuing.setDay7Start(rs.getDate(18));
                xissuing.setDay7End(rs.getDate(19));
                xissuing.setTime1Start(rs.getTimestamp(20));
                xissuing.setTime1End(rs.getTimestamp(21));
                xissuing.setTime2Start(rs.getTimestamp(22));
                xissuing.setTime2End(rs.getTimestamp(23));
                xissuing.setTime3Start(rs.getTimestamp(24));
                xissuing.setTime3End(rs.getTimestamp(25));
                xissuing.setTime4Start(rs.getTimestamp(26));
                xissuing.setTime4End(rs.getTimestamp(27));
                xissuing.setTime5Start(rs.getTimestamp(28));
                xissuing.setTime5End(rs.getTimestamp(29));
                xissuing.setTime6Start(rs.getTimestamp(30));
                xissuing.setTime6End(rs.getTimestamp(31));
                xissuing.setTime7Start(rs.getTimestamp(32));
                xissuing.setTime7End(rs.getTimestamp(33));
                xissuing.setHours1Start(new Integer(rs.getInt(34)));
                xissuing.setHours1End(new Integer(rs.getInt(35)));
                xissuing.setHours2Start(new Integer(rs.getInt(36)));
                xissuing.setHours2End(new Integer(rs.getInt(37)));
                xissuing.setHours3Start(new Integer(rs.getInt(38)));
                xissuing.setHours3End(new Integer(rs.getInt(39)));
                xissuing.setHours4Start(new Integer(rs.getInt(40)));
                xissuing.setHours4End(new Integer(rs.getInt(41)));
                xissuing.setHours5Start(new Integer(rs.getInt(42)));
                xissuing.setHours5End(new Integer(rs.getInt(43)));
                xissuing.setHours6Start(new Integer(rs.getInt(44)));
                xissuing.setHours6End(new Integer(rs.getInt(45)));
                xissuing.setHours7Start(new Integer(rs.getInt(46)));
                xissuing.setHours7End(new Integer(rs.getInt(47)));
                xissuing.setLiters1Start(new Integer(rs.getInt(48)));
                xissuing.setLiters1End(new Integer(rs.getInt(49)));
                xissuing.setLiters2Start(new Integer(rs.getInt(50)));
                xissuing.setLiters2End(new Integer(rs.getInt(51)));
                xissuing.setLiters3Start(new Integer(rs.getInt(52)));
                xissuing.setLiters3End(new Integer(rs.getInt(53)));
                xissuing.setLiters4Start(new Integer(rs.getInt(54)));
                xissuing.setLiters4End(new Integer(rs.getInt(55)));
                xissuing.setLiters5Start(new Integer(rs.getInt(56)));
                xissuing.setLiters5End(new Integer(rs.getInt(57)));
                xissuing.setLiters6Start(new Integer(rs.getInt(58)));
                xissuing.setLiters6End(new Integer(rs.getInt(59)));
                xissuing.setLiters7Start(new Integer(rs.getInt(60)));
                xissuing.setLiters7End(new Integer(rs.getInt(61)));
                xissuing.setIssuedby1Start(new Integer(rs.getInt(62)));
                xissuing.setIssuedby1End(new Integer(rs.getInt(63)));
                xissuing.setIssuedby2Start(new Integer(rs.getInt(64)));
                xissuing.setIssuedby2End(new Integer(rs.getInt(65)));
                xissuing.setIssuedby3Start(new Integer(rs.getInt(66)));
                xissuing.setIssuedby3End(new Integer(rs.getInt(67)));
                xissuing.setIssuedby4Start(new Integer(rs.getInt(68)));
                xissuing.setIssuedby4End(new Integer(rs.getInt(69)));
                xissuing.setIssuedby5Start(new Integer(rs.getInt(70)));
                xissuing.setIssuedby5End(new Integer(rs.getInt(71)));
                xissuing.setIssuedby6Start(new Integer(rs.getInt(72)));
                xissuing.setIssuedby6End(new Integer(rs.getInt(73)));
                xissuing.setIssuedby7Start(new Integer(rs.getInt(74)));
                xissuing.setIssuedby7End(new Integer(rs.getInt(75)));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xissuing ("+(getXissuingId().intValue()!=0?"xissuing_id,":"")+"issueddate,operator_id,xmachine_id,xsite_id,day1_start,day1_end,day2_start,day2_end,day3_start,day3_end,day4_start,day4_end,day5_start,day5_end,day6_start,day6_end,day7_start,day7_end,time1_start,time1_end,time2_start,time2_end,time3_start,time3_end,time4_start,time4_end,time5_start,time5_end,time6_start,time6_end,time7_start,time7_end,hours1_start,hours1_end,hours2_start,hours2_end,hours3_start,hours3_end,hours4_start,hours4_end,hours5_start,hours5_end,hours6_start,hours6_end,hours7_start,hours7_end,liters1_start,liters1_end,liters2_start,liters2_end,liters3_start,liters3_end,liters4_start,liters4_end,liters5_start,liters5_end,liters6_start,liters6_end,liters7_start,liters7_end,issuedby1_start,issuedby1_end,issuedby2_start,issuedby2_end,issuedby3_start,issuedby3_end,issuedby4_start,issuedby4_end,issuedby5_start,issuedby5_end,issuedby6_start,issuedby6_end,issuedby7_start,issuedby7_end) values("+(getXissuingId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
             ...
             ps.setObject(++n, getDay1Start());
             ps.setObject(++n, getDay1End());
             ps.setObject(++n, getDay2Start());
             ps.setObject(++n, getDay2End());
             ps.setObject(++n, getDay3Start());
             ps.setObject(++n, getDay3End());
             ps.setObject(++n, getDay4Start());
             ps.setObject(++n, getDay4End());
             ps.setObject(++n, getDay5Start());
             ps.setObject(++n, getDay5End());
             ps.setObject(++n, getDay6Start());
             ps.setObject(++n, getDay6End());
             ps.setObject(++n, getDay7Start());
             ps.setObject(++n, getDay7End());
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xissuing " +
                    "SET issueddate = ?, operator_id = ?, xmachine_id = ?, xsite_id = ?, day1_start = ?, day1_end = ?, day2_start = ?, day2_end = ?, day3_start = ?, day3_end = ?, day4_start = ?, day4_end = ?, day5_start = ?, day5_end = ?, day6_start = ?, day6_end = ?, day7_start = ?, day7_end = ?, time1_start = ?, time1_end = ?, time2_start = ?, time2_end = ?, time3_start = ?, time3_end = ?, time4_start = ?, time4_end = ?, time5_start = ?, time5_end = ?, time6_start = ?, time6_end = ?, time7_start = ?, time7_end = ?, hours1_start = ?, hours1_end = ?, hours2_start = ?, hours2_end = ?, hours3_start = ?, hours3_end = ?, hours4_start = ?, hours4_end = ?, hours5_start = ?, hours5_end = ?, hours6_start = ?, hours6_end = ?, hours7_start = ?, hours7_end = ?, liters1_start = ?, liters1_end = ?, liters2_start = ?, liters2_end = ?, liters3_start = ?, liters3_end = ?, liters4_start = ?, liters4_end = ?, liters5_start = ?, liters5_end = ?, liters6_start = ?, liters6_end = ?, liters7_start = ?, liters7_end = ?, issuedby1_start = ?, issuedby1_end = ?, issuedby2_start = ?, issuedby2_end = ?, issuedby3_start = ?, issuedby3_end = ?, issuedby4_start = ?, issuedby4_end = ?, issuedby5_start = ?, issuedby5_end = ?, issuedby6_start = ?, issuedby6_end = ?, issuedby7_start = ?, issuedby7_end = ?" + 
            ...
            try {
                ...
                ps.setObject(5, getDay1Start());
                ps.setObject(6, getDay1End());
                ps.setObject(7, getDay2Start());
                ps.setObject(8, getDay2End());
                ps.setObject(9, getDay3Start());
                ps.setObject(10, getDay3End());
                ps.setObject(11, getDay4Start());
                ps.setObject(12, getDay4End());
                ps.setObject(13, getDay5Start());
                ps.setObject(14, getDay5End());
                ps.setObject(15, getDay6Start());
                ps.setObject(16, getDay6End());
                ps.setObject(17, getDay7Start());
                ps.setObject(18, getDay7End());
                ps.setObject(19, getTime1Start());
                ps.setObject(20, getTime1End());
                ps.setObject(21, getTime2Start());
                ps.setObject(22, getTime2End());
                ps.setObject(23, getTime3Start());
                ps.setObject(24, getTime3End());
                ps.setObject(25, getTime4Start());
                ps.setObject(26, getTime4End());
                ps.setObject(27, getTime5Start());
                ps.setObject(28, getTime5End());
                ps.setObject(29, getTime6Start());
                ps.setObject(30, getTime6End());
                ps.setObject(31, getTime7Start());
                ps.setObject(32, getTime7End());
                ps.setObject(33, getHours1Start());
                ps.setObject(34, getHours1End());
                ps.setObject(35, getHours2Start());
                ps.setObject(36, getHours2End());
                ps.setObject(37, getHours3Start());
                ps.setObject(38, getHours3End());
                ps.setObject(39, getHours4Start());
                ps.setObject(40, getHours4End());
                ps.setObject(41, getHours5Start());
                ps.setObject(42, getHours5End());
                ps.setObject(43, getHours6Start());
                ps.setObject(44, getHours6End());
                ps.setObject(45, getHours7Start());
                ps.setObject(46, getHours7End());
                ps.setObject(47, getLiters1Start());
                ps.setObject(48, getLiters1End());
                ps.setObject(49, getLiters2Start());
                ps.setObject(50, getLiters2End());
                ps.setObject(51, getLiters3Start());
                ps.setObject(52, getLiters3End());
                ps.setObject(53, getLiters4Start());
                ps.setObject(54, getLiters4End());
                ps.setObject(55, getLiters5Start());
                ps.setObject(56, getLiters5End());
                ps.setObject(57, getLiters6Start());
                ps.setObject(58, getLiters6End());
                ps.setObject(59, getLiters7Start());
                ps.setObject(60, getLiters7End());
                ps.setObject(61, getIssuedby1Start());
                ps.setObject(62, getIssuedby1End());
                ps.setObject(63, getIssuedby2Start());
                ps.setObject(64, getIssuedby2End());
                ps.setObject(65, getIssuedby3Start());
                ps.setObject(66, getIssuedby3End());
                ps.setObject(67, getIssuedby4Start());
                ps.setObject(68, getIssuedby4End());
                ps.setObject(69, getIssuedby5Start());
                ps.setObject(70, getIssuedby5End());
                ps.setObject(71, getIssuedby6Start());
                ps.setObject(72, getIssuedby6End());
                ps.setObject(73, getIssuedby7Start());
                ps.setObject(74, getIssuedby7End());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public Date getDay1Start() {
        return day1Start;
    }

    public void setDay1Start(Date day1Start) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day1Start != null && !this.day1Start.equals(day1Start));
        this.day1Start = day1Start;
    }
    ...
    public void setDay1End(Date day1End) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day1End != null && !this.day1End.equals(day1End));
        this.day1End = day1End;
    }

    public Date getDay2Start() {
        return day2Start;
    }

    public void setDay2Start(Date day2Start) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day2Start != null && !this.day2Start.equals(day2Start));
        this.day2Start = day2Start;
    }
    ...
    public void setDay2End(Date day2End) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day2End != null && !this.day2End.equals(day2End));
        this.day2End = day2End;
    }

    public Date getDay3Start() {
        return day3Start;
    }

    public void setDay3Start(Date day3Start) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day3Start != null && !this.day3Start.equals(day3Start));
        this.day3Start = day3Start;
    }
    ...
    public void setDay3End(Date day3End) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day3End != null && !this.day3End.equals(day3End));
        this.day3End = day3End;
    }

    public Date getDay4Start() {
        return day4Start;
    }

    public void setDay4Start(Date day4Start) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day4Start != null && !this.day4Start.equals(day4Start));
        this.day4Start = day4Start;
    }
    ...
    public void setDay4End(Date day4End) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day4End != null && !this.day4End.equals(day4End));
        this.day4End = day4End;
    }

    public Date getDay5Start() {
        return day5Start;
    }

    public void setDay5Start(Date day5Start) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day5Start != null && !this.day5Start.equals(day5Start));
        this.day5Start = day5Start;
    }
    ...
    public void setDay5End(Date day5End) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day5End != null && !this.day5End.equals(day5End));
        this.day5End = day5End;
    }

    public Date getDay6Start() {
        return day6Start;
    }

    public void setDay6Start(Date day6Start) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day6Start != null && !this.day6Start.equals(day6Start));
        this.day6Start = day6Start;
    }
    ...
    public void setDay6End(Date day6End) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day6End != null && !this.day6End.equals(day6End));
        this.day6End = day6End;
    }

    public Date getDay7Start() {
        return day7Start;
    }

    public void setDay7Start(Date day7Start) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day7Start != null && !this.day7Start.equals(day7Start));
        this.day7Start = day7Start;
    }
    ...
    public void setDay7End(Date day7End) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.day7End != null && !this.day7End.equals(day7End));
        this.day7End = day7End;
    }
    ...
    public Object[] getAsRow() {
        Object[] columnValues = new Object[75];
        ...
        columnValues[5] = getDay1Start();
        columnValues[6] = getDay1End();
        columnValues[7] = getDay2Start();
        columnValues[8] = getDay2End();
        columnValues[9] = getDay3Start();
        columnValues[10] = getDay3End();
        columnValues[11] = getDay4Start();
        columnValues[12] = getDay4End();
        columnValues[13] = getDay5Start();
        columnValues[14] = getDay5End();
        columnValues[15] = getDay6Start();
        columnValues[16] = getDay6End();
        columnValues[17] = getDay7Start();
        columnValues[18] = getDay7End();
        columnValues[19] = getTime1Start();
        columnValues[20] = getTime1End();
        columnValues[21] = getTime2Start();
        columnValues[22] = getTime2End();
        columnValues[23] = getTime3Start();
        columnValues[24] = getTime3End();
        columnValues[25] = getTime4Start();
        columnValues[26] = getTime4End();
        columnValues[27] = getTime5Start();
        columnValues[28] = getTime5End();
        columnValues[29] = getTime6Start();
        columnValues[30] = getTime6End();
        columnValues[31] = getTime7Start();
        columnValues[32] = getTime7End();
        columnValues[33] = getHours1Start();
        columnValues[34] = getHours1End();
        columnValues[35] = getHours2Start();
        columnValues[36] = getHours2End();
        columnValues[37] = getHours3Start();
        columnValues[38] = getHours3End();
        columnValues[39] = getHours4Start();
        columnValues[40] = getHours4End();
        columnValues[41] = getHours5Start();
        columnValues[42] = getHours5End();
        columnValues[43] = getHours6Start();
        columnValues[44] = getHours6End();
        columnValues[45] = getHours7Start();
        columnValues[46] = getHours7End();
        columnValues[47] = getLiters1Start();
        columnValues[48] = getLiters1End();
        columnValues[49] = getLiters2Start();
        columnValues[50] = getLiters2End();
        columnValues[51] = getLiters3Start();
        columnValues[52] = getLiters3End();
        columnValues[53] = getLiters4Start();
        columnValues[54] = getLiters4End();
        columnValues[55] = getLiters5Start();
        columnValues[56] = getLiters5End();
        columnValues[57] = getLiters6Start();
        columnValues[58] = getLiters6End();
        columnValues[59] = getLiters7Start();
        columnValues[60] = getLiters7End();
        columnValues[61] = getIssuedby1Start();
        columnValues[62] = getIssuedby1End();
        columnValues[63] = getIssuedby2Start();
        columnValues[64] = getIssuedby2End();
        columnValues[65] = getIssuedby3Start();
        columnValues[66] = getIssuedby3End();
        columnValues[67] = getIssuedby4Start();
        columnValues[68] = getIssuedby4End();
        columnValues[69] = getIssuedby5Start();
        columnValues[70] = getIssuedby5End();
        columnValues[71] = getIssuedby6Start();
        columnValues[72] = getIssuedby6End();
        columnValues[73] = getIssuedby7Start();
        columnValues[74] = getIssuedby7End();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        setDay1Start(toDate(flds[5]));
        setDay1End(toDate(flds[6]));
        setDay2Start(toDate(flds[7]));
        setDay2End(toDate(flds[8]));
        setDay3Start(toDate(flds[9]));
        setDay3End(toDate(flds[10]));
        setDay4Start(toDate(flds[11]));
        setDay4End(toDate(flds[12]));
        setDay5Start(toDate(flds[13]));
        setDay5End(toDate(flds[14]));
        setDay6Start(toDate(flds[15]));
        setDay6End(toDate(flds[16]));
        setDay7Start(toDate(flds[17]));
        setDay7End(toDate(flds[18]));
        setTime1Start(toTimeStamp(flds[19]));
        setTime1End(toTimeStamp(flds[20]));
        setTime2Start(toTimeStamp(flds[21]));
        setTime2End(toTimeStamp(flds[22]));
        setTime3Start(toTimeStamp(flds[23]));
        setTime3End(toTimeStamp(flds[24]));
        setTime4Start(toTimeStamp(flds[25]));
        setTime4End(toTimeStamp(flds[26]));
        setTime5Start(toTimeStamp(flds[27]));
        setTime5End(toTimeStamp(flds[28]));
        setTime6Start(toTimeStamp(flds[29]));
        setTime6End(toTimeStamp(flds[30]));
        setTime7Start(toTimeStamp(flds[31]));
        setTime7End(toTimeStamp(flds[32]));
        try {
            setHours1Start(Integer.parseInt(flds[33]));
        } catch(NumberFormatException ne) {
            setHours1Start(null);
        }
        try {
            setHours1End(Integer.parseInt(flds[34]));
        } catch(NumberFormatException ne) {
            setHours1End(null);
        }
        try {
            setHours2Start(Integer.parseInt(flds[35]));
        } catch(NumberFormatException ne) {
            setHours2Start(null);
        }
        try {
            setHours2End(Integer.parseInt(flds[36]));
        } catch(NumberFormatException ne) {
            setHours2End(null);
        }
        try {
            setHours3Start(Integer.parseInt(flds[37]));
        } catch(NumberFormatException ne) {
            setHours3Start(null);
        }
        try {
            setHours3End(Integer.parseInt(flds[38]));
        } catch(NumberFormatException ne) {
            setHours3End(null);
        }
        try {
            setHours4Start(Integer.parseInt(flds[39]));
        } catch(NumberFormatException ne) {
            setHours4Start(null);
        }
        try {
            setHours4End(Integer.parseInt(flds[40]));
        } catch(NumberFormatException ne) {
            setHours4End(null);
        }
        try {
            setHours5Start(Integer.parseInt(flds[41]));
        } catch(NumberFormatException ne) {
            setHours5Start(null);
        }
        try {
            setHours5End(Integer.parseInt(flds[42]));
        } catch(NumberFormatException ne) {
            setHours5End(null);
        }
        try {
            setHours6Start(Integer.parseInt(flds[43]));
        } catch(NumberFormatException ne) {
            setHours6Start(null);
        }
        try {
            setHours6End(Integer.parseInt(flds[44]));
        } catch(NumberFormatException ne) {
            setHours6End(null);
        }
        try {
            setHours7Start(Integer.parseInt(flds[45]));
        } catch(NumberFormatException ne) {
            setHours7Start(null);
        }
        try {
            setHours7End(Integer.parseInt(flds[46]));
        } catch(NumberFormatException ne) {
            setHours7End(null);
        }
        try {
            setLiters1Start(Integer.parseInt(flds[47]));
        } catch(NumberFormatException ne) {
            setLiters1Start(null);
        }
        try {
            setLiters1End(Integer.parseInt(flds[48]));
        } catch(NumberFormatException ne) {
            setLiters1End(null);
        }
        try {
            setLiters2Start(Integer.parseInt(flds[49]));
        } catch(NumberFormatException ne) {
            setLiters2Start(null);
        }
        try {
            setLiters2End(Integer.parseInt(flds[50]));
        } catch(NumberFormatException ne) {
            setLiters2End(null);
        }
        try {
            setLiters3Start(Integer.parseInt(flds[51]));
        } catch(NumberFormatException ne) {
            setLiters3Start(null);
        }
        try {
            setLiters3End(Integer.parseInt(flds[52]));
        } catch(NumberFormatException ne) {
            setLiters3End(null);
        }
        try {
            setLiters4Start(Integer.parseInt(flds[53]));
        } catch(NumberFormatException ne) {
            setLiters4Start(null);
        }
        try {
            setLiters4End(Integer.parseInt(flds[54]));
        } catch(NumberFormatException ne) {
            setLiters4End(null);
        }
        try {
            setLiters5Start(Integer.parseInt(flds[55]));
        } catch(NumberFormatException ne) {
            setLiters5Start(null);
        }
        try {
            setLiters5End(Integer.parseInt(flds[56]));
        } catch(NumberFormatException ne) {
            setLiters5End(null);
        }
        try {
            setLiters6Start(Integer.parseInt(flds[57]));
        } catch(NumberFormatException ne) {
            setLiters6Start(null);
        }
        try {
            setLiters6End(Integer.parseInt(flds[58]));
        } catch(NumberFormatException ne) {
            setLiters6End(null);
        }
        try {
            setLiters7Start(Integer.parseInt(flds[59]));
        } catch(NumberFormatException ne) {
            setLiters7Start(null);
        }
        try {
            setLiters7End(Integer.parseInt(flds[60]));
        } catch(NumberFormatException ne) {
            setLiters7End(null);
        }
        try {
            setIssuedby1Start(Integer.parseInt(flds[61]));
        } catch(NumberFormatException ne) {
            setIssuedby1Start(null);
        }
        try {
            setIssuedby1End(Integer.parseInt(flds[62]));
        } catch(NumberFormatException ne) {
            setIssuedby1End(null);
        }
        try {
            setIssuedby2Start(Integer.parseInt(flds[63]));
        } catch(NumberFormatException ne) {
            setIssuedby2Start(null);
        }
        try {
            setIssuedby2End(Integer.parseInt(flds[64]));
        } catch(NumberFormatException ne) {
            setIssuedby2End(null);
        }
        try {
            setIssuedby3Start(Integer.parseInt(flds[65]));
        } catch(NumberFormatException ne) {
            setIssuedby3Start(null);
        }
        try {
            setIssuedby3End(Integer.parseInt(flds[66]));
        } catch(NumberFormatException ne) {
            setIssuedby3End(null);
        }
        try {
            setIssuedby4Start(Integer.parseInt(flds[67]));
        } catch(NumberFormatException ne) {
            setIssuedby4Start(null);
        }
        try {
            setIssuedby4End(Integer.parseInt(flds[68]));
        } catch(NumberFormatException ne) {
            setIssuedby4End(null);
        }
        try {
            setIssuedby5Start(Integer.parseInt(flds[69]));
        } catch(NumberFormatException ne) {
            setIssuedby5Start(null);
        }
        try {
            setIssuedby5End(Integer.parseInt(flds[70]));
        } catch(NumberFormatException ne) {
            setIssuedby5End(null);
        }
        try {
            setIssuedby6Start(Integer.parseInt(flds[71]));
        } catch(NumberFormatException ne) {
            setIssuedby6Start(null);
        }
        try {
            setIssuedby6End(Integer.parseInt(flds[72]));
        } catch(NumberFormatException ne) {
            setIssuedby6End(null);
        }
        try {
            setIssuedby7Start(Integer.parseInt(flds[73]));
        } catch(NumberFormatException ne) {
            setIssuedby7Start(null);
        }
        try {
            setIssuedby7End(Integer.parseInt(flds[74]));
        } catch(NumberFormatException ne) {
