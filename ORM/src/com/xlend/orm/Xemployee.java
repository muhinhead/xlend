...
public class Xemployee extends DbObject  {
    ...
    public Xemployee(Connection connection) {
        ...
        setColumnNames(new String[]{"xemployee_id", "clock_num", "first_name", "sur_name", "nick_name", "id_num", "phone0_num", "phone1_num", "phone2_num", "relation1", "relation2", "address", "contract_len", "contract_start", "contract_end", "rate", "xposition_id", "taxnum", "photo", "photo2", "deceased", "dismissed", "absconded", "deceased_date", "dismissed_date", "absconded_date"});
    }

    public Xemployee(Connection connection, Integer xemployeeId, String clockNum, String firstName, String surName, String nickName, String idNum, String phone0Num, String phone1Num, String phone2Num, String relation1, String relation2, String address, Integer contractLen, Date contractStart, Date contractEnd, Integer rate, Integer xpositionId, String taxnum, Object photo, Object photo2, Integer deceased, Integer dismissed, Integer absconded, Date deceasedDate, Date dismissedDate, Date abscondedDate) {
        super(connection, "xemployee", "xemployee_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                xemployee.setDeceasedDate(rs.getDate(24));
                xemployee.setDismissedDate(rs.getDate(25));
                xemployee.setAbscondedDate(rs.getDate(26));
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xemployee " +
                    "SET clock_num = ?, first_name = ?, sur_name = ?, nick_name = ?, id_num = ?, phone0_num = ?, phone1_num = ?, phone2_num = ?, relation1 = ?, relation2 = ?, address = ?, contract_len = ?, contract_start = ?, contract_end = ?, rate = ?, xposition_id = ?, taxnum = ?, photo = ?, photo2 = ?, deceased = ?, dismissed = ?, absconded = ?, deceased_date = ?, dismissed_date = ?, absconded_date = ?" + 
            ...
            try {
                ...
                ps.setObject(23, getDeceasedDate());
                ps.setObject(24, getDismissedDate());
                ps.setObject(25, getAbscondedDate());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public Object[] getAsRow() {
        Object[] columnValues = new Object[26];
        ...
        columnValues[23] = getDeceasedDate();
        columnValues[24] = getDismissedDate();
        columnValues[25] = getAbscondedDate();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        setDeceasedDate(toDate(flds[23]));
        setDismissedDate(toDate(flds[24]));
        setAbscondedDate(toDate(flds[25]));
    }
}
