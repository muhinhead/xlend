...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        if (Xdiesel2plant.exists(getConnection(),"xsupplier_id = " + getXsupplierId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xdiesel2plant_xsupplier_fk");
        }
