...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        if (Xmachineorder.exists(getConnection(),"xorder_id = " + getXorderId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xmachineorder_xorder_fk");
        }
