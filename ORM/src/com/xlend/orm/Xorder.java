// Generated by com.xlend.orm.tools.dbgen.DbGenerator.class at Tue Nov 29 17:36:10 EET 2011
...
public class Xorder extends DbObject  {
    ...
    public Xorder(Connection connection) {
        ...
        setColumnNames(new String[]{"xorder_id", "xclient_id", "xcontract_id", "xquotation_id", "vatnumber", "regnumber", "ordernumber", "orderdate", "contactname", "contactphone", "contactfax", "deliveryaddress", "invoiceaddress"});
    }

    public Xorder(Connection connection, Integer xorderId, Integer xclientId, Integer xcontractId, Integer xquotationId, String vatnumber, String regnumber, String ordernumber, Date orderdate, String contactname, String contactphone, String contactfax, String deliveryaddress, String invoiceaddress) {
        super(connection, "xorder", "xorder_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xorder_id,xclient_id,xcontract_id,xquotation_id,vatnumber,regnumber,ordernumber,orderdate,contactname,contactphone,contactfax,deliveryaddress,invoiceaddress FROM xorder WHERE xorder_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xorder.setVatnumber(rs.getString(5));
                xorder.setRegnumber(rs.getString(6));
                xorder.setOrdernumber(rs.getString(7));
                xorder.setOrderdate(rs.getDate(8));
                xorder.setContactname(rs.getString(9));
                xorder.setContactphone(rs.getString(10));
                xorder.setContactfax(rs.getString(11));
                xorder.setDeliveryaddress(rs.getString(12));
                xorder.setInvoiceaddress(rs.getString(13));
                xorder.setNew(false);
            }
        } finally {
            try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xorder ("+(getXorderId().intValue()!=0?"xorder_id,":"")+"xclient_id,xcontract_id,xquotation_id,vatnumber,regnumber,ordernumber,orderdate,contactname,contactphone,contactfax,deliveryaddress,invoiceaddress) values("+(getXorderId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xorder " +
                    "SET xclient_id = ?, xcontract_id = ?, xquotation_id = ?, vatnumber = ?, regnumber = ?, ordernumber = ?, orderdate = ?, contactname = ?, contactphone = ?, contactfax = ?, deliveryaddress = ?, invoiceaddress = ?" + 
            ...
            try {
                ...
                ps.setObject(4, getVatnumber());
                ps.setObject(5, getRegnumber());
                ps.setObject(6, getOrdernumber());
                ps.setObject(7, getOrderdate());
                ps.setObject(8, getContactname());
                ps.setObject(9, getContactphone());
                ps.setObject(10, getContactfax());
                ps.setObject(11, getDeliveryaddress());
                ps.setObject(12, getInvoiceaddress());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xorder_id,xclient_id,xcontract_id,xquotation_id,vatnumber,regnumber,ordernumber,orderdate,contactname,contactphone,contactfax,deliveryaddress,invoiceaddress FROM xorder " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xorder(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),new Integer(rs.getInt(3)),new Integer(rs.getInt(4)),rs.getString(5),rs.getString(6),rs.getString(7),rs.getDate(8),rs.getString(9),rs.getString(10),rs.getString(11),rs.getString(12),rs.getString(13)));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public void setRegnumber(String regnumber) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.regnumber != null && !this.regnumber.equals(regnumber));
        this.regnumber = regnumber;
    }
    ...
    public Object[] getAsRow() {
        ...
        columnValues[4] = getVatnumber();
        columnValues[5] = getRegnumber();
        columnValues[6] = getOrdernumber();
        columnValues[7] = getOrderdate();
        columnValues[8] = getContactname();
        columnValues[9] = getContactphone();
        columnValues[10] = getContactfax();
        columnValues[11] = getDeliveryaddress();
        columnValues[12] = getInvoiceaddress();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        setVatnumber(flds[4]);
        setRegnumber(flds[5]);
        setOrdernumber(flds[6]);
        setOrderdate(toDate(flds[7]));
        setContactname(flds[8]);
        setContactphone(flds[9]);
        setContactfax(flds[10]);
        setDeliveryaddress(flds[11]);
        setInvoiceaddress(flds[12]);
    }
}
