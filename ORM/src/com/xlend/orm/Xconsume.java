...
public class Xconsume extends DbObject  {
    ...
    public Xconsume(Connection connection) {
        ...
        setColumnNames(new String[]{"xconsume_id", "xsupplier_id", "xmachine_id", "requester_id", "invoicedate", "invoicenumber", "authorizer_id", "collector_id", "description", "partnumber", "amount_liters", "amount_rands", "payer_id", "xpaidmethod_id", "chequenumber"});
    }

    public Xconsume(Connection connection, Integer xconsumeId, Integer xsupplierId, Integer xmachineId, Integer requesterId, Date invoicedate, String invoicenumber, Integer authorizerId, Integer collectorId, String description, String partnumber, Integer amountLiters, Double amountRands, Integer payerId, Integer xpaidmethodId, String chequenumber) {
        super(connection, "xconsume", "xconsume_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xconsume_id,xsupplier_id,xmachine_id,requester_id,invoicedate,invoicenumber,authorizer_id,collector_id,description,partnumber,amount_liters,amount_rands,payer_id,xpaidmethod_id,chequenumber FROM xconsume WHERE xconsume_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xconsume ("+(getXconsumeId().intValue()!=0?"xconsume_id,":"")+"xsupplier_id,xmachine_id,requester_id,invoicedate,invoicenumber,authorizer_id,collector_id,description,partnumber,amount_liters,amount_rands,payer_id,xpaidmethod_id,chequenumber) values("+(getXconsumeId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xconsume " +
                    "SET xsupplier_id = ?, xmachine_id = ?, requester_id = ?, invoicedate = ?, invoicenumber = ?, authorizer_id = ?, collector_id = ?, description = ?, partnumber = ?, amount_liters = ?, amount_rands = ?, payer_id = ?, xpaidmethod_id = ?, chequenumber = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xconsume_id,xsupplier_id,xmachine_id,requester_id,invoicedate,invoicenumber,authorizer_id,collector_id,description,partnumber,amount_liters,amount_rands,payer_id,xpaidmethod_id,chequenumber FROM xconsume " +
