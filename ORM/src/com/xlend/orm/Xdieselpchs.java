...
public class Xdieselpchs extends DbObject  {
    ...
    public Xdieselpchs(Connection connection, Integer xdieselpchsId, Integer xsupplierId, Date purchased, Integer authorizerId, Integer amountLiters, Integer amountRands, Integer paidbyId, Integer xpaidmethodId) {
        super(connection, "xdieselpchs", "xdieselpchs_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                xdieselpchs.setAmountRands(new Integer(rs.getInt(6)));
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xdieselpchs(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),rs.getDate(3),new Integer(rs.getInt(4)),new Integer(rs.getInt(5)),new Integer(rs.getInt(6)),new Integer(rs.getInt(7)),new Integer(rs.getInt(8))));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setAmountRands(Integer.parseInt(flds[5]));
        } catch(NumberFormatException ne) {
            setAmountRands(null);
        }
        try {
