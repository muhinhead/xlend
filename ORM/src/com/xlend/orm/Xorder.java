// Generated by com.xlend.orm.tools.dbgen.DbGenerator.class at Mon Nov 21 08:20:41 EET 2011
...
public class Xorder extends DbObject  {
    ...
    public Xorder(Connection connection) {
        ...
        setColumnNames(new String[]{"xorder_id", "xclient_id", "xcontract_id", "vatnumber", "regnumber", "ordernumber", "orderdate", "contactname", "contactphone", "contactfax", "deliveryaddress", "invoiceaddress"});
    }

    public Xorder(Connection connection, Integer xorderId, Integer xclientId, Integer xcontractId, String vatnumber, String regnumber, String ordernumber, Date orderdate, String contactname, String contactphone, String contactfax, String deliveryaddress, String invoiceaddress) {
        super(connection, "xorder", "xorder_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xorder_id,xclient_id,xcontract_id,vatnumber,regnumber,ordernumber,orderdate,contactname,contactphone,contactfax,deliveryaddress,invoiceaddress FROM xorder WHERE xorder_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xorder.setVatnumber(rs.getString(4));
                xorder.setRegnumber(rs.getString(5));
                xorder.setOrdernumber(rs.getString(6));
                xorder.setOrderdate(rs.getDate(7));
                xorder.setContactname(rs.getString(8));
                xorder.setContactphone(rs.getString(9));
                xorder.setContactfax(rs.getString(10));
                xorder.setDeliveryaddress(rs.getString(11));
                xorder.setInvoiceaddress(rs.getString(12));
                xorder.setNew(false);
            }
        } finally {
            try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xorder ("+(getXorderId().intValue()!=0?"xorder_id,":"")+"xclient_id,xcontract_id,vatnumber,regnumber,ordernumber,orderdate,contactname,contactphone,contactfax,deliveryaddress,invoiceaddress) values("+(getXorderId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xorder " +
                    "SET xclient_id = ?, xcontract_id = ?, vatnumber = ?, regnumber = ?, ordernumber = ?, orderdate = ?, contactname = ?, contactphone = ?, contactfax = ?, deliveryaddress = ?, invoiceaddress = ?" + 
                    " WHERE xorder_id = " + getXorderId();
            try {
                ps = getConnection().prepareStatement(stmt);
                ps.setObject(1, getXclientId());
                ps.setObject(2, getXcontractId());
                ps.setObject(3, getVatnumber());
                ps.setObject(4, getRegnumber());
                ps.setObject(5, getOrdernumber());
                ps.setObject(6, getOrderdate());
                ps.setObject(7, getContactname());
                ps.setObject(8, getContactphone());
                ps.setObject(9, getContactfax());
                ps.setObject(10, getDeliveryaddress());
                ps.setObject(11, getInvoiceaddress());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xorder_id,xclient_id,xcontract_id,vatnumber,regnumber,ordernumber,orderdate,contactname,contactphone,contactfax,deliveryaddress,invoiceaddress FROM xorder " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xorder(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),new Integer(rs.getInt(3)),rs.getString(4),rs.getString(5),rs.getString(6),rs.getDate(7),rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11),rs.getString(12)));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public Object[] getAsRow() {
        ...
        columnValues[3] = getVatnumber();
        columnValues[4] = getRegnumber();
        columnValues[5] = getOrdernumber();
        columnValues[6] = getOrderdate();
        columnValues[7] = getContactname();
        columnValues[8] = getContactphone();
        columnValues[9] = getContactfax();
        columnValues[10] = getDeliveryaddress();
        columnValues[11] = getInvoiceaddress();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        setVatnumber(flds[3]);
        setRegnumber(flds[4]);
        setOrdernumber(flds[5]);
        setOrderdate(toDate(flds[6]));
        setContactname(flds[7]);
        setContactphone(flds[8]);
        setContactfax(flds[9]);
        setDeliveryaddress(flds[10]);
        setInvoiceaddress(flds[11]);
    }
}
