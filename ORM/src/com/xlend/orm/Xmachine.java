...
public class Xmachine extends DbObject  {
    ...
    private Integer isLowbed = null;

    public Xmachine(Connection connection) {
        super(connection, "xmachine", "xmachine_id");
        setColumnNames(new String[]{"xmachine_id", "tmvnr", "xmachtype_id", "xmachtype2_id", "reg_nr", "expdate", "vehicleid_nr", "engine_nr", "chassis_nr", "classify", "insurance_nr", "insurance_tp", "insurance_amt", "deposit_amt", "contract_fee", "monthly_pay", "paystart", "payend", "photo", "consumption", "fueltype", "is_lowbed"});
    }

    public Xmachine(Connection connection, Integer xmachineId, String tmvnr, Integer xmachtypeId, Integer xmachtype2Id, String regNr, Date expdate, String vehicleidNr, String engineNr, String chassisNr, String classify, String insuranceNr, String insuranceTp, Double insuranceAmt, Double depositAmt, Integer contractFee, Integer monthlyPay, Date paystart, Date payend, Object photo, Integer consumption, Integer fueltype, Integer isLowbed) {
        super(connection, "xmachine", "xmachine_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xmachine_id,tmvnr,xmachtype_id,xmachtype2_id,reg_nr,expdate,vehicleid_nr,engine_nr,chassis_nr,classify,insurance_nr,insurance_tp,insurance_amt,deposit_amt,contract_fee,monthly_pay,paystart,payend,photo,consumption,fueltype,is_lowbed FROM xmachine WHERE xmachine_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xmachine.setIsLowbed(new Integer(rs.getInt(22)));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xmachine ("+(getXmachineId().intValue()!=0?"xmachine_id,":"")+"tmvnr,xmachtype_id,xmachtype2_id,reg_nr,expdate,vehicleid_nr,engine_nr,chassis_nr,classify,insurance_nr,insurance_tp,insurance_amt,deposit_amt,contract_fee,monthly_pay,paystart,payend,photo,consumption,fueltype,is_lowbed) values("+(getXmachineId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xmachine " +
                    "SET tmvnr = ?, xmachtype_id = ?, xmachtype2_id = ?, reg_nr = ?, expdate = ?, vehicleid_nr = ?, engine_nr = ?, chassis_nr = ?, classify = ?, insurance_nr = ?, insurance_tp = ?, insurance_amt = ?, deposit_amt = ?, contract_fee = ?, monthly_pay = ?, paystart = ?, payend = ?, photo = ?, consumption = ?, fueltype = ?, is_lowbed = ?" + 
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        if (Xpettyitem.exists(getConnection(),"xmachine_id = " + getXmachineId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xpettyitem_xmachine_fk");
        }
        ...
        if (Xmachineorderitm.exists(getConnection(),"xmachine_id = " + getXmachineId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xmachineorderitm_xmachine_fk");
        }
        ...
        if (Xtransscheduleitm.exists(getConnection(),"lowbed_id = " + getXmachineId())) {
        ...
        if (Xtrip.exists(getConnection(),"xlowbed_id = " + getXmachineId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xtrip_xmachine_fk1");
        }
        ...
        if (Xtripsheet.exists(getConnection(),"xlowbed_id = " + getXmachineId())) {
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xmachine_id,tmvnr,xmachtype_id,xmachtype2_id,reg_nr,expdate,vehicleid_nr,engine_nr,chassis_nr,classify,insurance_nr,insurance_tp,insurance_amt,deposit_amt,contract_fee,monthly_pay,paystart,payend,photo,consumption,fueltype,is_lowbed FROM xmachine " +
    ...
    public Integer getIsLowbed() {
        return isLowbed;
    }

    public void setIsLowbed(Integer isLowbed) throws SQLException, ForeignKeyViolationException {
        if (null != isLowbed)
            isLowbed = isLowbed == 0 ? null : isLowbed;
        setWasChanged(this.isLowbed != null && !this.isLowbed.equals(isLowbed));
        this.isLowbed = isLowbed;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setIsLowbed(Integer.parseInt(flds[21]));
        } catch(NumberFormatException ne) {
            setIsLowbed(null);
        }
    }
