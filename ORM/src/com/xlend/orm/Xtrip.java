...
public class Xtrip extends DbObject  {
    ...
    public Xtrip(Connection connection) {
        ...
        setColumnNames(new String[]{"xtrip_id", "xlowbed_id", "trip_date", "fromsite_id", "insite_id", "tosite_id", "driver_id", "assistant_id", "trip_type", "distance_empty", "distance_loaded", "machine_id", "withmachine_id", "is_copmplete", "operator_id"});
    }

    public Xtrip(Connection connection, Integer xtripId, Integer xlowbedId, Date tripDate, Integer fromsiteId, Integer insiteId, Integer tositeId, Integer driverId, Integer assistantId, Integer tripType, Integer distanceEmpty, Integer distanceLoaded, Integer machineId, Integer withmachineId, Integer isCopmplete, Integer operatorId) {
        super(connection, "xtrip", "xtrip_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xtrip_id,xlowbed_id,trip_date,fromsite_id,insite_id,tosite_id,driver_id,assistant_id,trip_type,distance_empty,distance_loaded,machine_id,withmachine_id,is_copmplete,operator_id FROM xtrip WHERE xtrip_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xtrip.setDriverId(new Integer(rs.getInt(7)));
                xtrip.setAssistantId(new Integer(rs.getInt(8)));
                xtrip.setTripType(new Integer(rs.getInt(9)));
                xtrip.setDistanceEmpty(new Integer(rs.getInt(10)));
                xtrip.setDistanceLoaded(new Integer(rs.getInt(11)));
                xtrip.setMachineId(new Integer(rs.getInt(12)));
                xtrip.setWithmachineId(new Integer(rs.getInt(13)));
                xtrip.setIsCopmplete(new Integer(rs.getInt(14)));
                xtrip.setOperatorId(new Integer(rs.getInt(15)));
                xtrip.setNew(false);
            }
        } finally {
            try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xtrip ("+(getXtripId().intValue()!=0?"xtrip_id,":"")+"xlowbed_id,trip_date,fromsite_id,insite_id,tosite_id,driver_id,assistant_id,trip_type,distance_empty,distance_loaded,machine_id,withmachine_id,is_copmplete,operator_id) values("+(getXtripId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xtrip " +
                    "SET xlowbed_id = ?, trip_date = ?, fromsite_id = ?, insite_id = ?, tosite_id = ?, driver_id = ?, assistant_id = ?, trip_type = ?, distance_empty = ?, distance_loaded = ?, machine_id = ?, withmachine_id = ?, is_copmplete = ?, operator_id = ?" + 
            ...
            try {
                ...
                ps.setObject(7, getAssistantId());
                ps.setObject(8, getTripType());
                ps.setObject(9, getDistanceEmpty());
                ps.setObject(10, getDistanceLoaded());
                ps.setObject(11, getMachineId());
                ps.setObject(12, getWithmachineId());
                ps.setObject(13, getIsCopmplete());
                ps.setObject(14, getOperatorId());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xtrip_id,xlowbed_id,trip_date,fromsite_id,insite_id,tosite_id,driver_id,assistant_id,trip_type,distance_empty,distance_loaded,machine_id,withmachine_id,is_copmplete,operator_id FROM xtrip " +
    ...
    public Object[] getAsRow() {
        ...
        columnValues[7] = getAssistantId();
        columnValues[8] = getTripType();
        columnValues[9] = getDistanceEmpty();
        columnValues[10] = getDistanceLoaded();
        columnValues[11] = getMachineId();
        columnValues[12] = getWithmachineId();
        columnValues[13] = getIsCopmplete();
        columnValues[14] = getOperatorId();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setAssistantId(Integer.parseInt(flds[7]));
        } catch(NumberFormatException ne) {
            setAssistantId(null);
        }
        try {
            setTripType(Integer.parseInt(flds[8]));
        } catch(NumberFormatException ne) {
            setTripType(null);
        }
        try {
            setDistanceEmpty(Integer.parseInt(flds[9]));
        } catch(NumberFormatException ne) {
            setDistanceEmpty(null);
        }
        try {
            setDistanceLoaded(Integer.parseInt(flds[10]));
        } catch(NumberFormatException ne) {
            setDistanceLoaded(null);
        }
        try {
            setMachineId(Integer.parseInt(flds[11]));
        } catch(NumberFormatException ne) {
            setMachineId(null);
        }
        try {
            setWithmachineId(Integer.parseInt(flds[12]));
        } catch(NumberFormatException ne) {
            setWithmachineId(null);
        }
        try {
            setIsCopmplete(Integer.parseInt(flds[13]));
        } catch(NumberFormatException ne) {
            setIsCopmplete(null);
        }
        try {
            setOperatorId(Integer.parseInt(flds[14]));
        } catch(NumberFormatException ne) {
            setOperatorId(null);
        }
    }
