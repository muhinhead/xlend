...
public class Xsite extends DbObject  {
    ...
    public Xsite(Connection connection) {
        ...
        setColumnNames(new String[]{"xsite_id", "name", "description", "dieselsponsor", "sitetype", "xorder_id", "xorder2_id", "xorder3_id"});
    }

    public Xsite(Connection connection, Integer xsiteId, String name, String description, Integer dieselsponsor, String sitetype, Integer xorderId, Integer xorder2Id, Integer xorder3Id) {
        super(connection, "xsite", "xsite_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xsite_id,name,description,dieselsponsor,sitetype,xorder_id,xorder2_id,xorder3_id FROM xsite WHERE xsite_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xsite ("+(getXsiteId().intValue()!=0?"xsite_id,":"")+"name,description,dieselsponsor,sitetype,xorder_id,xorder2_id,xorder3_id) values("+(getXsiteId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xsite " +
                    "SET name = ?, description = ?, dieselsponsor = ?, sitetype = ?, xorder_id = ?, xorder2_id = ?, xorder3_id = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xsite_id,name,description,dieselsponsor,sitetype,xorder_id,xorder2_id,xorder3_id FROM xsite " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xsite(con,new Integer(rs.getInt(1)),rs.getString(2),rs.getString(3),new Integer(rs.getInt(4)),rs.getString(5),new Integer(rs.getInt(6)),new Integer(rs.getInt(7)),new Integer(rs.getInt(8))));
                dbObj.setNew(false);
            }
        } finally {
            try {
