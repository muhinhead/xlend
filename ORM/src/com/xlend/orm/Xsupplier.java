...
public class Xsupplier extends DbObject  {
    ...
    public Xsupplier(Connection connection) {
        ...
        setColumnNames(new String[]{"xsupplier_id", "companyname", "contactperson", "productdesc", "phone", "fax", "cell", "email", "vatnr", "company_regnr", "address", "banking", "credit_limit"});
    }

    public Xsupplier(Connection connection, Integer xsupplierId, String companyname, String contactperson, String productdesc, String phone, String fax, String cell, String email, String vatnr, String companyRegnr, String address, String banking, Integer creditLimit) {
        super(connection, "xsupplier", "xsupplier_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xsupplier_id,companyname,contactperson,productdesc,phone,fax,cell,email,vatnr,company_regnr,address,banking,credit_limit FROM xsupplier WHERE xsupplier_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xsupplier ("+(getXsupplierId().intValue()!=0?"xsupplier_id,":"")+"companyname,contactperson,productdesc,phone,fax,cell,email,vatnr,company_regnr,address,banking,credit_limit) values("+(getXsupplierId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xsupplier " +
                    "SET companyname = ?, contactperson = ?, productdesc = ?, phone = ?, fax = ?, cell = ?, email = ?, vatnr = ?, company_regnr = ?, address = ?, banking = ?, credit_limit = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xsupplier_id,companyname,contactperson,productdesc,phone,fax,cell,email,vatnr,company_regnr,address,banking,credit_limit FROM xsupplier " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xsupplier(con,new Integer(rs.getInt(1)),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11),rs.getString(12),new Integer(rs.getInt(13))));
                dbObj.setNew(false);
            }
        } finally {
            try {
