...
public class Xppebuyitem extends DbObject  {
    ...
    public Xppebuyitem(Connection connection) {
        ...
        setColumnNames(new String[]{"xppebuyitem_id", "xppebuy_id", "xppetype_id", "quantity"});
    }

    public Xppebuyitem(Connection connection, Integer xppebuyitemId, Integer xppebuyId, Integer xppetypeId, Integer quantity) {
        super(connection, "xppebuyitem", "xppebuyitem_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xppebuyitem_id,xppebuy_id,xppetype_id,quantity FROM xppebuyitem WHERE xppebuyitem_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xppebuyitem ("+(getXppebuyitemId().intValue()!=0?"xppebuyitem_id,":"")+"xppebuy_id,xppetype_id,quantity) values("+(getXppebuyitemId().intValue()!=0?"?,":"")+"?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xppebuyitem " +
                    "SET xppebuy_id = ?, xppetype_id = ?, quantity = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xppebuyitem_id,xppebuy_id,xppetype_id,quantity FROM xppebuyitem " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xppebuyitem(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),new Integer(rs.getInt(3)),new Integer(rs.getInt(4))));
                dbObj.setNew(false);
            }
        } finally {
            try {
