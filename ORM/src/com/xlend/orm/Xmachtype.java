...
public class Xmachtype extends DbObject  {
    ...
    private Integer isRated = null;

    public Xmachtype(Connection connection) {
        super(connection, "xmachtype", "xmachtype_id");
        setColumnNames(new String[]{"xmachtype_id", "machtype", "parenttype_id", "classify", "is_rated"});
    }

    public Xmachtype(Connection connection, Integer xmachtypeId, String machtype, Integer parenttypeId, String classify, Integer isRated) {
        super(connection, "xmachtype", "xmachtype_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xmachtype_id,machtype,parenttype_id,classify,is_rated FROM xmachtype WHERE xmachtype_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xmachtype.setIsRated(new Integer(rs.getInt(5)));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xmachtype ("+(getXmachtypeId().intValue()!=0?"xmachtype_id,":"")+"machtype,parenttype_id,classify,is_rated) values("+(getXmachtypeId().intValue()!=0?"?,":"")+"?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xmachtype " +
                    "SET machtype = ?, parenttype_id = ?, classify = ?, is_rated = ?" + 
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        {// delete cascade from xmachrentalrateitm
            Xmachrentalrateitm[] records = (Xmachrentalrateitm[])Xmachrentalrateitm.load(getConnection(),"xmachtype_id = " + getXmachtypeId(),null);
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xmachtype_id,machtype,parenttype_id,classify,is_rated FROM xmachtype " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xmachtype(con,new Integer(rs.getInt(1)),rs.getString(2),new Integer(rs.getInt(3)),rs.getString(4),new Integer(rs.getInt(5))));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public void setIsRated(Integer isRated) throws SQLException, ForeignKeyViolationException {
        if (null != isRated)
            isRated = isRated == 0 ? null : isRated;
        setWasChanged(this.isRated != null && !this.isRated.equals(isRated));
        this.isRated = isRated;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        setClassify(flds[3]);
        try {
            setIsRated(Integer.parseInt(flds[4]));
        } catch(NumberFormatException ne) {
            setIsRated(null);
        }
    }
