...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        if (Xtimesheet.exists(getConnection(),"xclient_id = " + getXclientId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xtimesheet_xclient_fk");
        }
