...
public class Xtimesheet extends DbObject  {
    ...
    public Xtimesheet(Connection connection) {
        ...
        setColumnNames(new String[]{"xtimesheet_id", "xemployee_id", "xclient_id", "xsite_id", "weekend", "clocksheet", "image"});
    }

    public Xtimesheet(Connection connection, Integer xtimesheetId, Integer xemployeeId, Integer xclientId, Integer xsiteId, Date weekend, Integer clocksheet, Object image) {
        super(connection, "xtimesheet", "xtimesheet_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xtimesheet_id,xemployee_id,xclient_id,xsite_id,weekend,clocksheet,image FROM xtimesheet WHERE xtimesheet_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xtimesheet.setXclientId(new Integer(rs.getInt(3)));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xtimesheet ("+(getXtimesheetId().intValue()!=0?"xtimesheet_id,":"")+"xemployee_id,xclient_id,xsite_id,weekend,clocksheet,image) values("+(getXtimesheetId().intValue()!=0?"?,":"")+"?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xtimesheet " +
                    "SET xemployee_id = ?, xclient_id = ?, xsite_id = ?, weekend = ?, clocksheet = ?, image = ?" + 
                    " WHERE xtimesheet_id = " + getXtimesheetId();
            try {
                ps = getConnection().prepareStatement(stmt);
                ps.setObject(1, getXemployeeId());
                ps.setObject(2, getXclientId());
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xtimesheet_id,xemployee_id,xclient_id,xsite_id,weekend,clocksheet,image FROM xtimesheet " +
    ...
    public void setXclientId(Integer xclientId) throws SQLException, ForeignKeyViolationException {
        if (xclientId!=null && !Xclient.exists(getConnection(),"xclient_id = " + xclientId)) {
            throw new ForeignKeyViolationException("Can't set xclient_id, foreign key violation: xtimesheet_xclient_fk");
        }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setXclientId(Integer.parseInt(flds[2]));
        } catch(NumberFormatException ne) {
            setXclientId(null);
        }
        try {
