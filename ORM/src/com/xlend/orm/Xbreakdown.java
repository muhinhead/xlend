...
public class Xbreakdown extends DbObject  {
    ...
    private Double km2site1way = null;
    private Double hoursonjob = null;
    private Timestamp timeleft = null;
    private Timestamp timeback = null;
    private Integer stayedover = null;
    private Integer accomprice = null;
    private String invoicenumber = null;
    private Double amount = null;
    private Double standingHours = null;

    public Xbreakdown(Connection connection) {
        super(connection, "xbreakdown", "xbreakdown_id");
        setColumnNames(new String[]{"xbreakdown_id", "breakdowndate", "xmachine_id", "xsite_id", "reportedto_id", "reportedby_id", "attendedby_id", "vehicle_id", "repairdate", "repaired", "operatorfault", "operator_id", "km2site1way", "hoursonjob", "timeleft", "timeback", "stayedover", "accomprice", "invoicenumber", "amount", "standing_hours"});
    }

    public Xbreakdown(Connection connection, Integer xbreakdownId, Date breakdowndate, Integer xmachineId, Integer xsiteId, Integer reportedtoId, Integer reportedbyId, Integer attendedbyId, Integer vehicleId, Date repairdate, Integer repaired, Integer operatorfault, Integer operatorId, Double km2site1way, Double hoursonjob, Timestamp timeleft, Timestamp timeback, Integer stayedover, Integer accomprice, String invoicenumber, Double amount, Double standingHours) {
        super(connection, "xbreakdown", "xbreakdown_id");
...
//        }
        ...
        this.amount = amount;
        this.standingHours = standingHours;
    }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                xbreakdown.setKm2site1way(rs.getDouble(13));
                xbreakdown.setHoursonjob(rs.getDouble(14));
                xbreakdown.setTimeleft(rs.getTimestamp(15));
                xbreakdown.setTimeback(rs.getTimestamp(16));
                ...
                xbreakdown.setStandingHours(rs.getDouble(21));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xbreakdown ("+(getXbreakdownId().intValue()!=0?"xbreakdown_id,":"")+"breakdowndate,xmachine_id,xsite_id,reportedto_id,reportedby_id,attendedby_id,vehicle_id,repairdate,repaired,operatorfault,operator_id,km2site1way,hoursonjob,timeleft,timeback,stayedover,accomprice,invoicenumber,amount,standing_hours) values("+(getXbreakdownId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
             ...
             ps.setObject(++n, getStandingHours());
             ps.execute();
         } finally {
             if (ps != null) ps.close();
         }
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xbreakdown " +
                    "SET breakdowndate = ?, xmachine_id = ?, xsite_id = ?, reportedto_id = ?, reportedby_id = ?, attendedby_id = ?, vehicle_id = ?, repairdate = ?, repaired = ?, operatorfault = ?, operator_id = ?, km2site1way = ?, hoursonjob = ?, timeleft = ?, timeback = ?, stayedover = ?, accomprice = ?, invoicenumber = ?, amount = ?, standing_hours = ?" + 
            ...
            try {
                ...
                ps.setObject(20, getStandingHours());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xbreakdown_id,breakdowndate,xmachine_id,xsite_id,reportedto_id,reportedby_id,attendedby_id,vehicle_id,repairdate,repaired,operatorfault,operator_id,km2site1way,hoursonjob,timeleft,timeback,stayedover,accomprice,invoicenumber,amount,standing_hours FROM xbreakdown " +
    ...
    public Double getKm2site1way() {
        return km2site1way;
    }

    public void setKm2site1way(Double km2site1way) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.km2site1way != null && !this.km2site1way.equals(km2site1way));
        this.km2site1way = km2site1way;
    }

    public Double getHoursonjob() {
        return hoursonjob;
    }

    public void setHoursonjob(Double hoursonjob) throws SQLException, ForeignKeyViolationException {
    ...
    public void setTimeleft(Timestamp timeleft) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.timeleft != null && !this.timeleft.equals(timeleft));
        this.timeleft = timeleft;
    }

    public Timestamp getTimeback() {
        return timeback;
    }

    public void setTimeback(Timestamp timeback) throws SQLException, ForeignKeyViolationException {
    ...
    public Double getStandingHours() {
        return standingHours;
    }

    public void setStandingHours(Double standingHours) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.standingHours != null && !this.standingHours.equals(standingHours));
        this.standingHours = standingHours;
    }
    public Object[] getAsRow() {
        ...
        columnValues[20] = getStandingHours();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setKm2site1way(Double.parseDouble(flds[12]));
        } catch(NumberFormatException ne) {
            setKm2site1way(null);
        }
        try {
            setHoursonjob(Double.parseDouble(flds[13]));
        } catch(NumberFormatException ne) {
            setHoursonjob(null);
        }
        setTimeleft(toTimeStamp(flds[14]));
        setTimeback(toTimeStamp(flds[15]));
        try {
        ...
        try {
            setStandingHours(Double.parseDouble(flds[20]));
        } catch(NumberFormatException ne) {
            setStandingHours(null);
        }
    }
}
