...
//        }
    ...
    public void setXmachtype2Id(Integer xmachtype2Id) throws SQLException, ForeignKeyViolationException {
        ...
        if (xmachtype2Id!=null && !Xmachtype.exists(getConnection(),"xmachtype_id = " + xmachtype2Id)) {
            throw new ForeignKeyViolationException("Can't set xmachtype2_id, foreign key violation: xmachine_xmachtype_fk2");
        }
