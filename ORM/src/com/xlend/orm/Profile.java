// Generated by com.xlend.orm.tools.dbgen.DbGenerator.class at Wed Nov 09 07:14:56 GMT 2011
...
public class Profile extends DbObject  {
    ...
    public Profile(Connection connection) {
        ...
        setColumnNames(new String[]{"profile_id", "first_name", "last_name", "address1", "address2", "city", "state", "zip_code", "phone", "cell_phone", "email", "photo"});
    }

    public Profile(Connection connection, Integer profileId, String firstName, String lastName, String address1, String address2, String city, String state, String zipCode, String phone, String cellPhone, String email, Object photo) {
        super(connection, "profile", "profile_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT profile_id,first_name,last_name,address1,address2,city,state,zip_code,phone,cell_phone,email,photo FROM profile WHERE profile_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                profile.setPhoto(rs.getObject(12));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO profile ("+(getProfileId().intValue()!=0?"profile_id,":"")+"first_name,last_name,address1,address2,city,state,zip_code,phone,cell_phone,email,photo) values("+(getProfileId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE profile " +
                    "SET first_name = ?, last_name = ?, address1 = ?, address2 = ?, city = ?, state = ?, zip_code = ?, phone = ?, cell_phone = ?, email = ?, photo = ?" + 
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        if (Boperator.exists(getConnection(),"profile_id = " + getProfileId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: boperator_profile_fk");
        }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT profile_id,first_name,last_name,address1,address2,city,state,zip_code,phone,cell_phone,email,photo FROM profile " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Profile(con,new Integer(rs.getInt(1)),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8),rs.getString(9),rs.getString(10),rs.getString(11),rs.getObject(12)));
                dbObj.setNew(false);
            }
        } finally {
            try {
