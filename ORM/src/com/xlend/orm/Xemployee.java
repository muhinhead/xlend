...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        if (Xopmachassing.exists(getConnection(),"xemployee_id = " + getXemployeeId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xopmachassing_xemployee_fk");
        }
