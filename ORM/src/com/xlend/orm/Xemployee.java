...
public class Xemployee extends DbObject  {
    ...
    public Xemployee(Connection connection) {
        ...
        setColumnNames(new String[]{"xemployee_id", "clock_num", "first_name", "sur_name", "nick_name", "id_num", "phone0_num", "phone1_num", "phone2_num", "relation1", "relation2", "address", "contract_len", "contract_start", "contract_end", "rate", "xposition_id", "taxnum", "photo", "photo2", "deceased", "dismissed", "absconded", "resigned", "deceased_date", "dismissed_date", "absconded_date", "resigned_date", "wage_category", "bank_details"});
    }

    public Xemployee(Connection connection, Integer xemployeeId, String clockNum, String firstName, String surName, String nickName, String idNum, String phone0Num, String phone1Num, String phone2Num, String relation1, String relation2, String address, Integer contractLen, Date contractStart, Date contractEnd, Integer rate, Integer xpositionId, String taxnum, Object photo, Object photo2, Integer deceased, Integer dismissed, Integer absconded, Integer resigned, Date deceasedDate, Date dismissedDate, Date abscondedDate, Date resignedDate, Integer wageCategory, String bankDetails) {
        super(connection, "xemployee", "xemployee_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xemployee_id,clock_num,first_name,sur_name,nick_name,id_num,phone0_num,phone1_num,phone2_num,relation1,relation2,address,contract_len,contract_start,contract_end,rate,xposition_id,taxnum,photo,photo2,deceased,dismissed,absconded,resigned,deceased_date,dismissed_date,absconded_date,resigned_date,wage_category,bank_details FROM xemployee WHERE xemployee_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xemployee.setWageCategory(new Integer(rs.getInt(29)));
                xemployee.setBankDetails(rs.getString(30));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xemployee ("+(getXemployeeId().intValue()!=0?"xemployee_id,":"")+"clock_num,first_name,sur_name,nick_name,id_num,phone0_num,phone1_num,phone2_num,relation1,relation2,address,contract_len,contract_start,contract_end,rate,xposition_id,taxnum,photo,photo2,deceased,dismissed,absconded,resigned,deceased_date,dismissed_date,absconded_date,resigned_date,wage_category,bank_details) values("+(getXemployeeId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            try {
                ...
                ps.setObject(28, getWageCategory());
                ps.setObject(29, getBankDetails());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        if (Xloans.exists(getConnection(),"represent_id = " + getXemployeeId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xloans_xemployee_fk3");
        }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xemployee_id,clock_num,first_name,sur_name,nick_name,id_num,phone0_num,phone1_num,phone2_num,relation1,relation2,address,contract_len,contract_start,contract_end,rate,xposition_id,taxnum,photo,photo2,deceased,dismissed,absconded,resigned,deceased_date,dismissed_date,absconded_date,resigned_date,wage_category,bank_details FROM xemployee " +
    ...
    public void setBankDetails(String bankDetails) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.bankDetails != null && !this.bankDetails.equals(bankDetails));
        this.bankDetails = bankDetails;
    }
    public Object[] getAsRow() {
        Object[] columnValues = new Object[30];
        ...
        columnValues[28] = getWageCategory();
        columnValues[29] = getBankDetails();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setWageCategory(Integer.parseInt(flds[28]));
        } catch(NumberFormatException ne) {
            setWageCategory(null);
        }
        setBankDetails(flds[29]);
    }
}
