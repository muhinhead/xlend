...
public class Xcreditor extends DbObject  {
    ...
    private Integer invoiceammount = null;
    private Integer paid = null;
    private Integer outstandammount = null;
    private Integer paidfrom = null;

    public Xcreditor(Connection connection) {
        super(connection, "xcreditor", "xcreditor_id");
        setColumnNames(new String[]{"xcreditor_id", "xsupplier_id", "xconsume_id", "accnum", "invoiceammount", "paid", "outstandammount", "paidfrom"});
    }

    public Xcreditor(Connection connection, Integer xcreditorId, Integer xsupplierId, Integer xconsumeId, String accnum, Integer invoiceammount, Integer paid, Integer outstandammount, Integer paidfrom) {
        super(connection, "xcreditor", "xcreditor_id");
...
//        }
        ...
        this.paid = paid;
        this.outstandammount = outstandammount;
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xcreditor_id,xsupplier_id,xconsume_id,accnum,invoiceammount,paid,outstandammount,paidfrom FROM xcreditor WHERE xcreditor_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xcreditor.setInvoiceammount(new Integer(rs.getInt(5)));
                xcreditor.setPaid(new Integer(rs.getInt(6)));
                xcreditor.setOutstandammount(new Integer(rs.getInt(7)));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xcreditor ("+(getXcreditorId().intValue()!=0?"xcreditor_id,":"")+"xsupplier_id,xconsume_id,accnum,invoiceammount,paid,outstandammount,paidfrom) values("+(getXcreditorId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
             ...
             ps.setObject(++n, getOutstandammount());
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xcreditor " +
                    "SET xsupplier_id = ?, xconsume_id = ?, accnum = ?, invoiceammount = ?, paid = ?, outstandammount = ?, paidfrom = ?" + 
            ...
            try {
                ...
                ps.setObject(6, getOutstandammount());
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xcreditor_id,xsupplier_id,xconsume_id,accnum,invoiceammount,paid,outstandammount,paidfrom FROM xcreditor " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xcreditor(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),new Integer(rs.getInt(3)),rs.getString(4),new Integer(rs.getInt(5)),new Integer(rs.getInt(6)),new Integer(rs.getInt(7)),new Integer(rs.getInt(8))));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public void setInvoiceammount(Integer invoiceammount) throws SQLException, ForeignKeyViolationException {
        if (null != invoiceammount)
            invoiceammount = invoiceammount == 0 ? null : invoiceammount;
    ...
    public Integer getOutstandammount() {
        return outstandammount;
    }

    public void setOutstandammount(Integer outstandammount) throws SQLException, ForeignKeyViolationException {
        if (null != outstandammount)
            outstandammount = outstandammount == 0 ? null : outstandammount;
        setWasChanged(this.outstandammount != null && !this.outstandammount.equals(outstandammount));
        this.outstandammount = outstandammount;
    }
    ...
    public Object[] getAsRow() {
        ...
        columnValues[6] = getOutstandammount();
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        setAccnum(flds[3]);
        try {
            setInvoiceammount(Integer.parseInt(flds[4]));
        } catch(NumberFormatException ne) {
        ...
        try {
            setOutstandammount(Integer.parseInt(flds[6]));
        } catch(NumberFormatException ne) {
            setOutstandammount(null);
        }
        try {
