...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        if (Xpartstocks.exists(getConnection(),"xsupplier_id = " + getXsupplierId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xpartstocks_xsupplier_fk");
        }
        if (getTriggers() != null) {
