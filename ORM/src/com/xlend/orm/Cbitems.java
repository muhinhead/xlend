...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        if (Xmachrentalrateitm.exists(getConnection(),"cbitem_id = " + getCbitemId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xmachrentalrateitm_cbitem_fk");
        }
        if (getTriggers() != null) {
