...
<!--            <div id="my-div" style="position:absolute; left: 465px; top: 8px;">
        ...
        <form>
            <% Util.TableCeil[] addCeils = new Util.TableCeil[]{
                    new Util.TableCeil("Last updated") {
                        ...
                        public String getCeil(int id) {
                            return DbConnection.getStampOnID(id, "xincidents", connection);
                        }
                    },
                    new Util.TableCeil("") {
                        @Override
            ...
            <%=Util.showTable(Selects.SELECT_FROM_INCIDENTS.replaceAll("where requestedby_id=#", ""), connection, addCeils)%>
        </form>
    </body>
</html>
