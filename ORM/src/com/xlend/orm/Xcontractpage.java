...
public class Xcontractpage extends DbObject  {
    ...
    public Xcontractpage(Connection connection) {
        ...
        setColumnNames(new String[]{"xcontractpage_id", "xcontract_id", "pagenum", "description", "pagescan"});
    }

    public Xcontractpage(Connection connection, Integer xcontractpageId, Integer xcontractId, Integer pagenum, String description, Object pagescan) {
        super(connection, "xcontractpage", "xcontractpage_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xcontractpage_id,xcontract_id,pagenum,description,pagescan FROM xcontractpage WHERE xcontractpage_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xcontractpage ("+(getXcontractpageId().intValue()!=0?"xcontractpage_id,":"")+"xcontract_id,pagenum,description,pagescan) values("+(getXcontractpageId().intValue()!=0?"?,":"")+"?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    ...
                    "SET xcontract_id = ?, pagenum = ?, description = ?, pagescan = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xcontractpage_id,xcontract_id,pagenum,description,pagescan FROM xcontractpage " +
