// Generated by com.xlend.orm.tools.dbgen.DbGenerator.class at Fri Nov 11 16:59:18 EET 2011
...
public class Xclient extends DbObject  {
    ...
    public Xclient(Connection connection) {
        ...
        setColumnNames(new String[]{"xclient_id", "clientcode", "companyname", "contactname", "phonenumber", "vatnumber", "address"});
    }

    public Xclient(Connection connection, Integer xclientId, String clientcode, String companyname, String contactname, String phonenumber, String vatnumber, String address) {
        super(connection, "xclient", "xclient_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xclient_id,clientcode,companyname,contactname,phonenumber,vatnumber,address FROM xclient WHERE xclient_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xclient ("+(getXclientId().intValue()!=0?"xclient_id,":"")+"clientcode,companyname,contactname,phonenumber,vatnumber,address) values("+(getXclientId().intValue()!=0?"?,":"")+"?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xclient " +
                    "SET clientcode = ?, companyname = ?, contactname = ?, phonenumber = ?, vatnumber = ?, address = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xclient_id,clientcode,companyname,contactname,phonenumber,vatnumber,address FROM xclient " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xclient(con,new Integer(rs.getInt(1)),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7)));
                dbObj.setNew(false);
            }
        } finally {
            try {
