// Generated by com.xlend.orm.tools.dbgen.DbGenerator.class at Wed Nov 16 09:40:09 EET 2011
...
public class Xcontractpage extends DbObject  {
    ...
    public Xcontractpage(Connection connection) {
        ...
        setColumnNames(new String[]{"xcontractpage_id", "xcontract_id", "pagenum", "decsription", "pagescan"});
    }

    public Xcontractpage(Connection connection, Integer xcontractpageId, Integer xcontractId, Integer pagenum, String decsription, Object pagescan) {
        super(connection, "xcontractpage", "xcontractpage_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xcontractpage_id,xcontract_id,pagenum,decsription,pagescan FROM xcontractpage WHERE xcontractpage_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xcontractpage.setDecsription(rs.getString(4));
                xcontractpage.setPagescan(rs.getObject(5));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xcontractpage ("+(getXcontractpageId().intValue()!=0?"xcontractpage_id,":"")+"xcontract_id,pagenum,decsription,pagescan) values("+(getXcontractpageId().intValue()!=0?"?,":"")+"?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xcontractpage_id,xcontract_id,pagenum,decsription,pagescan FROM xcontractpage " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xcontractpage(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),new Integer(rs.getInt(3)),rs.getString(4),rs.getObject(5)));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public void setDecsription(String decsription) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.decsription != null && !this.decsription.equals(decsription));
        this.decsription = decsription;
    }
