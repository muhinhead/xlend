// Generated by com.xlend.orm.tools.dbgen.DbGenerator.class at Tue Dec 06 11:56:50 EET 2011
...
public class Xwage extends DbObject  {
    ...
    public Xwage(Connection connection) {
        ...
        setColumnNames(new String[]{"xwage_id", "xtimesheet_id", "day", "normaltime", "overtime", "doubletime", "stoppeddetails"});
    }

    public Xwage(Connection connection, Integer xwageId, Integer xtimesheetId, Date day, Double normaltime, Double overtime, Double doubletime, String stoppeddetails) {
        super(connection, "xwage", "xwage_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xwage_id,xtimesheet_id,day,normaltime,overtime,doubletime,stoppeddetails FROM xwage WHERE xwage_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xwage ("+(getXwageId().intValue()!=0?"xwage_id,":"")+"xtimesheet_id,day,normaltime,overtime,doubletime,stoppeddetails) values("+(getXwageId().intValue()!=0?"?,":"")+"?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xwage " +
                    "SET xtimesheet_id = ?, day = ?, normaltime = ?, overtime = ?, doubletime = ?, stoppeddetails = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xwage_id,xtimesheet_id,day,normaltime,overtime,doubletime,stoppeddetails FROM xwage " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xwage(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),rs.getDate(3),rs.getDouble(4),rs.getDouble(5),rs.getDouble(6),rs.getString(7)));
                dbObj.setNew(false);
            }
        } finally {
            try {
