<%-- 
    Document   : hourcomparisons
    Created on : 09.02.2014, 16:40:19
    Author     : Nick Mukhin
--%>

<%@page import="com.xlend.constants.Selects"%>
<%@page import="com.xlend.orm.Xhourcompare"%>
...
<html>
    ...
    <% final String imgFile = "tab_hourcomp.png";%>
    <% ImagePanel maxImg = new ImagePanel(Util.loadImage(imgFile, getServletContext()));%>
    <% DbObject[] compares = Xhourcompare.load(connection, null, null);%>
    <head>
        <style type="text/css">
            <!--
...
<!--            <div  id="my-div" style="position:absolute; left: 710px; top: 8px;">
        ...
        <h3>List of <%=compares.length%> compares</h3>
        <form>
            <%=Util.showTable(Selects.SELECT_FROM_HOURCOMPARE, connection, null)%>
        </form>
    </body>
