<%-- 
    Document   : hr_quotas
    Created on : 09.02.2014, 14:42:44
    Author     : Nick Mukhin
--%>

<%@page import="com.xlend.constants.Selects"%>
<%@page import="com.xlend.orm.Xquotation"%>
...
<html>
    ...
    <% final String imgFile = "tabs_quotes.png";%>
    <% ImagePanel maxImg = new ImagePanel(Util.loadImage(imgFile, getServletContext()));%>
    <% DbObject[] quotation = Xquotation.load(connection, null, null);%>
    <head>
        <style type="text/css">
            <!--
    ...
    <body background="images/metallic-gears-background-.jpg">
        ...
        <h3>List of <%=quotation.length%> quotas</h3>
        <form>
            <%=Util.showTable(Selects.SELECT_FROM_QUOTATIONS, connection, null)%>
        </form>
    </body>
