...
public class Xbreakdown extends DbObject  {
    ...
    public Xbreakdown(Connection connection) {
        ...
        setColumnNames(new String[]{"xbreakdown_id", "breakdowndate", "xmachine_id", "xsite_id", "reportedto_id", "reportedby_id", "attendedby_id", "vehicle_id", "repairdate", "repaired", "description", "operatorfault", "operator_id", "xconsume_id", "km2site1way", "hoursonjob", "timeleft", "timeback", "stayedover", "accomprice", "invoicenumber", "amount"});
    }

    public Xbreakdown(Connection connection, Integer xbreakdownId, Date breakdowndate, Integer xmachineId, Integer xsiteId, Integer reportedtoId, Integer reportedbyId, Integer attendedbyId, Integer vehicleId, Date repairdate, Integer repaired, String description, Integer operatorfault, Integer operatorId, Integer xconsumeId, Integer km2site1way, Integer hoursonjob, Integer timeleft, Integer timeback, Integer stayedover, Integer accomprice, String invoicenumber, Double amount) {
        super(connection, "xbreakdown", "xbreakdown_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                xbreakdown.setInvoicenumber(rs.getString(21));
                xbreakdown.setAmount(rs.getDouble(22));
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xbreakdown " +
                    "SET breakdowndate = ?, xmachine_id = ?, xsite_id = ?, reportedto_id = ?, reportedby_id = ?, attendedby_id = ?, vehicle_id = ?, repairdate = ?, repaired = ?, description = ?, operatorfault = ?, operator_id = ?, xconsume_id = ?, km2site1way = ?, hoursonjob = ?, timeleft = ?, timeback = ?, stayedover = ?, accomprice = ?, invoicenumber = ?, amount = ?" + 
            ...
            try {
                ...
                ps.setObject(20, getInvoicenumber());
                ps.setObject(21, getAmount());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xbreakdown_id,breakdowndate,xmachine_id,xsite_id,reportedto_id,reportedby_id,attendedby_id,vehicle_id,repairdate,repaired,description,operatorfault,operator_id,xconsume_id,km2site1way,hoursonjob,timeleft,timeback,stayedover,accomprice,invoicenumber,amount FROM xbreakdown " +
    ...
    public Object[] getAsRow() {
        Object[] columnValues = new Object[22];
        ...
        columnValues[20] = getInvoicenumber();
        columnValues[21] = getAmount();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        setInvoicenumber(flds[20]);
        try {
            setAmount(Double.parseDouble(flds[21]));
        } catch(NumberFormatException ne) {
            setAmount(null);
        }
    }
