...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xoperator_id,first_name,full_name,last_name,id_num,clock_num,clocksheets,rate,monday_normtm,monday_overtm,monday_double,tuesday_normtm,tuesday_overtm,tuesday_double,wednesday_normtm,wednesday_overtm,wednesday_double,thursday_normtm,thursday_overtm,thursday_double,friday_normtm,friday_overtm,friday_double,saturday_overtm,saturday_double,sunday_overtm,sunday_double,total_normtm,total_overtm,total_double,photo FROM xoperator WHERE xoperator_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xoperator.setPhoto(rs.getObject(31));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xoperator ("+(getXoperatorId().intValue()!=0?"xoperator_id,":"")+"first_name,full_name,last_name,id_num,clock_num,clocksheets,rate,monday_normtm,monday_overtm,monday_double,tuesday_normtm,tuesday_overtm,tuesday_double,wednesday_normtm,wednesday_overtm,wednesday_double,thursday_normtm,thursday_overtm,thursday_double,friday_normtm,friday_overtm,friday_double,saturday_overtm,saturday_double,sunday_overtm,sunday_double,total_normtm,total_overtm,total_double,photo) values("+(getXoperatorId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xoperator_id,first_name,full_name,last_name,id_num,clock_num,clocksheets,rate,monday_normtm,monday_overtm,monday_double,tuesday_normtm,tuesday_overtm,tuesday_double,wednesday_normtm,wednesday_overtm,wednesday_double,thursday_normtm,thursday_overtm,thursday_double,friday_normtm,friday_overtm,friday_double,saturday_overtm,saturday_double,sunday_overtm,sunday_double,total_normtm,total_overtm,total_double,photo FROM xoperator " +
