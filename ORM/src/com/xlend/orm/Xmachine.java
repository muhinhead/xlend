...
public class Xmachine extends DbObject  {
    ...
    public Xmachine(Connection connection) {
        ...
        setColumnNames(new String[]{"xmachine_id", "tmvnr", "xmachtype_id", "xmachtype2_id", "reg_nr", "expdate", "vehicleid_nr", "engine_nr", "chassis_nr", "classify", "insurance_nr", "insurance_tp", "insurance_amt", "deposit_amt", "contract_fee", "monthly_pay", "paystart", "payend", "photo", "consumption"});
    }

    public Xmachine(Connection connection, Integer xmachineId, String tmvnr, Integer xmachtypeId, Integer xmachtype2Id, String regNr, Date expdate, String vehicleidNr, String engineNr, String chassisNr, String classify, String insuranceNr, String insuranceTp, Double insuranceAmt, Double depositAmt, Integer contractFee, Integer monthlyPay, Date paystart, Date payend, Object photo, Integer consumption) {
        super(connection, "xmachine", "xmachine_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xmachine_id,tmvnr,xmachtype_id,xmachtype2_id,reg_nr,expdate,vehicleid_nr,engine_nr,chassis_nr,classify,insurance_nr,insurance_tp,insurance_amt,deposit_amt,contract_fee,monthly_pay,paystart,payend,photo,consumption FROM xmachine WHERE xmachine_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xmachine ("+(getXmachineId().intValue()!=0?"xmachine_id,":"")+"tmvnr,xmachtype_id,xmachtype2_id,reg_nr,expdate,vehicleid_nr,engine_nr,chassis_nr,classify,insurance_nr,insurance_tp,insurance_amt,deposit_amt,contract_fee,monthly_pay,paystart,payend,photo,consumption) values("+(getXmachineId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xmachine " +
                    "SET tmvnr = ?, xmachtype_id = ?, xmachtype2_id = ?, reg_nr = ?, expdate = ?, vehicleid_nr = ?, engine_nr = ?, chassis_nr = ?, classify = ?, insurance_nr = ?, insurance_tp = ?, insurance_amt = ?, deposit_amt = ?, contract_fee = ?, monthly_pay = ?, paystart = ?, payend = ?, photo = ?, consumption = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xmachine_id,tmvnr,xmachtype_id,xmachtype2_id,reg_nr,expdate,vehicleid_nr,engine_nr,chassis_nr,classify,insurance_nr,insurance_tp,insurance_amt,deposit_amt,contract_fee,monthly_pay,paystart,payend,photo,consumption FROM xmachine " +
