...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        if (Xbreakconsume.exists(getConnection(),"xbreakdown_id = " + getXbreakdownId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xbreakconsume_xbreakdown_fk");
        }
        if (getTriggers() != null) {
