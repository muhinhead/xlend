...
create cached table xsitediarypart -- discarded!
(
...
(
    ...
    constraint xparts_xmachtype_id foreign key (xmachtype_id) references xmachtype,
    constraint xparts_xpartcategory_fk foreign key (xpartcategory_id) references xpartcategory
);
...
create cached table xstocks
(
    xstocks_id      int generated by default as identity (start with 1),
    name            varchar(64) not null,
...
(
    xpartstocks_id int generated by default as identity (start with 1),
