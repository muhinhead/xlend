...
public class Xtrip extends DbObject  {
    ...
    public Xtrip(Connection connection) {
        ...
        setColumnNames(new String[]{"xtrip_id", "xlowbed_id", "trip_date", "fromsite_id", "insite_id", "tosite_id", "loaded", "distance", "driver_id", "assistant_id", "trip_type", "distance_empty", "distance_loaded", "machine_id", "withmachine_id", "is_copmplete"});
    }

    public Xtrip(Connection connection, Integer xtripId, Integer xlowbedId, Date tripDate, Integer fromsiteId, Integer insiteId, Integer tositeId, Integer loaded, Integer distance, Integer driverId, Integer assistantId, Integer tripType, Integer distanceEmpty, Integer distanceLoaded, Integer machineId, Integer withmachineId, Integer isCopmplete) {
        super(connection, "xtrip", "xtrip_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xtrip_id,xlowbed_id,trip_date,fromsite_id,insite_id,tosite_id,loaded,distance,driver_id,assistant_id,trip_type,distance_empty,distance_loaded,machine_id,withmachine_id,is_copmplete FROM xtrip WHERE xtrip_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xtrip.setLoaded(new Integer(rs.getInt(7)));
                xtrip.setDistance(new Integer(rs.getInt(8)));
                xtrip.setDriverId(new Integer(rs.getInt(9)));
                xtrip.setAssistantId(new Integer(rs.getInt(10)));
                xtrip.setTripType(new Integer(rs.getInt(11)));
                xtrip.setDistanceEmpty(new Integer(rs.getInt(12)));
                xtrip.setDistanceLoaded(new Integer(rs.getInt(13)));
                xtrip.setMachineId(new Integer(rs.getInt(14)));
                xtrip.setWithmachineId(new Integer(rs.getInt(15)));
                xtrip.setIsCopmplete(new Integer(rs.getInt(16)));
                xtrip.setNew(false);
            }
        } finally {
            try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xtrip ("+(getXtripId().intValue()!=0?"xtrip_id,":"")+"xlowbed_id,trip_date,fromsite_id,insite_id,tosite_id,loaded,distance,driver_id,assistant_id,trip_type,distance_empty,distance_loaded,machine_id,withmachine_id,is_copmplete) values("+(getXtripId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xtrip " +
                    "SET xlowbed_id = ?, trip_date = ?, fromsite_id = ?, insite_id = ?, tosite_id = ?, loaded = ?, distance = ?, driver_id = ?, assistant_id = ?, trip_type = ?, distance_empty = ?, distance_loaded = ?, machine_id = ?, withmachine_id = ?, is_copmplete = ?" + 
            ...
            try {
                ...
                ps.setObject(6, getLoaded());
                ps.setObject(7, getDistance());
                ps.setObject(8, getDriverId());
                ps.setObject(9, getAssistantId());
                ps.setObject(10, getTripType());
                ps.setObject(11, getDistanceEmpty());
                ps.setObject(12, getDistanceLoaded());
                ps.setObject(13, getMachineId());
                ps.setObject(14, getWithmachineId());
                ps.setObject(15, getIsCopmplete());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xtrip_id,xlowbed_id,trip_date,fromsite_id,insite_id,tosite_id,loaded,distance,driver_id,assistant_id,trip_type,distance_empty,distance_loaded,machine_id,withmachine_id,is_copmplete FROM xtrip " +
    ...
    public Object[] getAsRow() {
        ...
        columnValues[6] = getLoaded();
        columnValues[7] = getDistance();
        columnValues[8] = getDriverId();
        columnValues[9] = getAssistantId();
        columnValues[10] = getTripType();
        columnValues[11] = getDistanceEmpty();
        columnValues[12] = getDistanceLoaded();
        columnValues[13] = getMachineId();
        columnValues[14] = getWithmachineId();
        columnValues[15] = getIsCopmplete();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setLoaded(Integer.parseInt(flds[6]));
        } catch(NumberFormatException ne) {
            setLoaded(null);
        }
        try {
            setDistance(Integer.parseInt(flds[7]));
        } catch(NumberFormatException ne) {
            setDistance(null);
        }
        try {
            setDriverId(Integer.parseInt(flds[8]));
        } catch(NumberFormatException ne) {
            setDriverId(null);
        }
        try {
            setAssistantId(Integer.parseInt(flds[9]));
        } catch(NumberFormatException ne) {
            setAssistantId(null);
        }
        try {
            setTripType(Integer.parseInt(flds[10]));
        } catch(NumberFormatException ne) {
            setTripType(null);
        }
        try {
            setDistanceEmpty(Integer.parseInt(flds[11]));
        } catch(NumberFormatException ne) {
            setDistanceEmpty(null);
        }
        try {
            setDistanceLoaded(Integer.parseInt(flds[12]));
        } catch(NumberFormatException ne) {
            setDistanceLoaded(null);
        }
        try {
            setMachineId(Integer.parseInt(flds[13]));
        } catch(NumberFormatException ne) {
            setMachineId(null);
        }
        try {
            setWithmachineId(Integer.parseInt(flds[14]));
        } catch(NumberFormatException ne) {
            setWithmachineId(null);
        }
        try {
            setIsCopmplete(Integer.parseInt(flds[15]));
        } catch(NumberFormatException ne) {
            setIsCopmplete(null);
        }
    }
