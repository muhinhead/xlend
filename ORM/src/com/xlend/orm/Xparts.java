...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        if (Xaddstocks.exists(getConnection(),"xparts_id = " + getXpartsId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xaddstocks_xparts_fk");
        }
        if (Xbookouts.exists(getConnection(),"xparts_id = " + getXpartsId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xbookouts_xparts_fk");
        }
        if (getTriggers() != null) {
