...
public class Xquotation extends DbObject  {
    ...
    public Xquotation(Connection connection) {
        ...
        setColumnNames(new String[]{"xquotation_id", "xclient_id", "rfcnumber", "received", "deadline", "responded", "responsedby", "responsecmnt", "responsedoc"});
    }

    public Xquotation(Connection connection, Integer xquotationId, Integer xclientId, String rfcnumber, Date received, Date deadline, Date responded, String responsedby, String responsecmnt, Object responsedoc) {
        super(connection, "xquotation", "xquotation_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xquotation_id,xclient_id,rfcnumber,received,deadline,responded,responsedby,responsecmnt,responsedoc FROM xquotation WHERE xquotation_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xquotation.setResponsedoc(rs.getObject(9));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xquotation ("+(getXquotationId().intValue()!=0?"xquotation_id,":"")+"xclient_id,rfcnumber,received,deadline,responded,responsedby,responsecmnt,responsedoc) values("+(getXquotationId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xquotation " +
                    "SET xclient_id = ?, rfcnumber = ?, received = ?, deadline = ?, responded = ?, responsedby = ?, responsecmnt = ?, responsedoc = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xquotation_id,xclient_id,rfcnumber,received,deadline,responded,responsedby,responsecmnt,responsedoc FROM xquotation " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xquotation(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),rs.getString(3),rs.getDate(4),rs.getDate(5),rs.getDate(6),rs.getString(7),rs.getString(8),rs.getObject(9)));
                dbObj.setNew(false);
            }
        } finally {
            try {
