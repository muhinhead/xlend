...
public class Xbookouts extends DbObject  {
    ...
    public Xbookouts(Connection connection, Integer xbookoutsId, Integer xpartsId, Date issueDate, Integer xsiteId, Integer xmachineId, Integer issuedbyId, Integer issuedtoId, Integer quantity) {
        super(connection, "xbookouts", "xbookouts_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                xbookouts.setQuantity(new Integer(rs.getInt(8)));
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xbookouts(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),rs.getDate(3),new Integer(rs.getInt(4)),new Integer(rs.getInt(5)),new Integer(rs.getInt(6)),new Integer(rs.getInt(7)),new Integer(rs.getInt(8))));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setQuantity(Integer.parseInt(flds[7]));
        } catch(NumberFormatException ne) {
            setQuantity(null);
        }
    }
