...
public class Xemployeepenalty extends DbObject  {
    ...
    public Xemployeepenalty(Connection connection) {
        ...
        setColumnNames(new String[]{"xemployeepenalty_id", "points", "xemployee_id", "year", "xincidents_id", "decreased_at", "notes"});
    }

    public Xemployeepenalty(Connection connection, Integer xemployeepenaltyId, Integer points, Integer xemployeeId, Integer year, Integer xincidentsId, Date decreasedAt, String notes) {
        super(connection, "xemployeepenalty", "xemployeepenalty_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xemployeepenalty_id,points,xemployee_id,year,xincidents_id,decreased_at,notes FROM xemployeepenalty WHERE xemployeepenalty_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xemployeepenalty.setDecreasedAt(rs.getDate(6));
                xemployeepenalty.setNotes(rs.getString(7));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xemployeepenalty ("+(getXemployeepenaltyId().intValue()!=0?"xemployeepenalty_id,":"")+"points,xemployee_id,year,xincidents_id,decreased_at,notes) values("+(getXemployeepenaltyId().intValue()!=0?"?,":"")+"?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    ...
                    "SET points = ?, xemployee_id = ?, year = ?, xincidents_id = ?, decreased_at = ?, notes = ?" + 
            ...
            try {
                ...
                ps.setObject(5, getDecreasedAt());
                ps.setObject(6, getNotes());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xemployeepenalty_id,points,xemployee_id,year,xincidents_id,decreased_at,notes FROM xemployeepenalty " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xemployeepenalty(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),new Integer(rs.getInt(3)),new Integer(rs.getInt(4)),new Integer(rs.getInt(5)),rs.getDate(6),rs.getString(7)));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public Object[] getAsRow() {
        ...
        columnValues[5] = getDecreasedAt();
        columnValues[6] = getNotes();
        return columnValues;
    }
