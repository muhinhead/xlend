...
public class Xpetty extends DbObject  {
    ...
    public Xpetty(Connection connection, Integer xpettyId, Date issueDate, Integer xemployeeInId, Double amount, Double changeAmt, Double balance, Integer isLoan, Integer isPetty, Integer isAllowance, String notes, Date receiptDate, Integer xemployeeOutId) {
        super(connection, "xpetty", "xpetty_id");
...
//        }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xpetty(con,new Integer(rs.getInt(1)),rs.getDate(2),new Integer(rs.getInt(3)),rs.getDouble(4),rs.getDouble(5),rs.getDouble(6),new Integer(rs.getInt(7)),new Integer(rs.getInt(8)),new Integer(rs.getInt(9)),rs.getString(10),rs.getDate(11),new Integer(rs.getInt(12))));
                dbObj.setNew(false);
            }
        } finally {
            try {
