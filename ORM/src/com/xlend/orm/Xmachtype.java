...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        if (Xparts.exists(getConnection(),"xmachtype_id = " + getXmachtypeId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xparts_xmachtype_fk");
        }
        ...
        if (Xparts.exists(getConnection(),"xmachtype_id = " + getXmachtypeId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xparts_xmachtype_id");
        }
        if (getTriggers() != null) {
