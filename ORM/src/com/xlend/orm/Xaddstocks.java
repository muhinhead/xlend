...
public class Xaddstocks extends DbObject  {
    ...
    public Xaddstocks(Connection connection, Integer xaddstocksId, Integer xpartsId, Date purchaseDate, Integer enteredbyId, Integer xsupplierId, Double priceperunit, Integer quantity) {
        super(connection, "xaddstocks", "xaddstocks_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                xaddstocks.setQuantity(new Integer(rs.getInt(7)));
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xaddstocks(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),rs.getDate(3),new Integer(rs.getInt(4)),new Integer(rs.getInt(5)),rs.getDouble(6),new Integer(rs.getInt(7))));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setQuantity(Integer.parseInt(flds[6]));
        } catch(NumberFormatException ne) {
            setQuantity(null);
        }
    }
