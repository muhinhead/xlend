...
public class Xbreakdown extends DbObject  {
    ...
    public Xbreakdown(Connection connection) {
        ...
        setColumnNames(new String[]{"xbreakdown_id", "breakdowndate", "xmachine_id", "xsite_id", "reportedto_id", "reportedby_id", "attendedby_id", "vehicle_id", "repairdate", "repaired", "description", "operatorfault", "operator_id", "xconsume_id", "km2site1way", "hoursonjob", "timeleft", "timeback", "stayedover", "accomprice"});
    }

    public Xbreakdown(Connection connection, Integer xbreakdownId, Date breakdowndate, Integer xmachineId, Integer xsiteId, Integer reportedtoId, Integer reportedbyId, Integer attendedbyId, Integer vehicleId, Date repairdate, Integer repaired, String description, Integer operatorfault, Integer operatorId, Integer xconsumeId, Integer km2site1way, Integer hoursonjob, Integer timeleft, Integer timeback, Integer stayedover, Integer accomprice) {
        super(connection, "xbreakdown", "xbreakdown_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xbreakdown_id,breakdowndate,xmachine_id,xsite_id,reportedto_id,reportedby_id,attendedby_id,vehicle_id,repairdate,repaired,description,operatorfault,operator_id,xconsume_id,km2site1way,hoursonjob,timeleft,timeback,stayedover,accomprice FROM xbreakdown WHERE xbreakdown_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xbreakdown.setDescription(rs.getString(11));
                xbreakdown.setOperatorfault(new Integer(rs.getInt(12)));
                xbreakdown.setOperatorId(new Integer(rs.getInt(13)));
                xbreakdown.setXconsumeId(new Integer(rs.getInt(14)));
                xbreakdown.setKm2site1way(new Integer(rs.getInt(15)));
                xbreakdown.setHoursonjob(new Integer(rs.getInt(16)));
                xbreakdown.setTimeleft(new Integer(rs.getInt(17)));
                xbreakdown.setTimeback(new Integer(rs.getInt(18)));
                xbreakdown.setStayedover(new Integer(rs.getInt(19)));
                xbreakdown.setAccomprice(new Integer(rs.getInt(20)));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xbreakdown ("+(getXbreakdownId().intValue()!=0?"xbreakdown_id,":"")+"breakdowndate,xmachine_id,xsite_id,reportedto_id,reportedby_id,attendedby_id,vehicle_id,repairdate,repaired,description,operatorfault,operator_id,xconsume_id,km2site1way,hoursonjob,timeleft,timeback,stayedover,accomprice) values("+(getXbreakdownId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xbreakdown " +
                    "SET breakdowndate = ?, xmachine_id = ?, xsite_id = ?, reportedto_id = ?, reportedby_id = ?, attendedby_id = ?, vehicle_id = ?, repairdate = ?, repaired = ?, description = ?, operatorfault = ?, operator_id = ?, xconsume_id = ?, km2site1way = ?, hoursonjob = ?, timeleft = ?, timeback = ?, stayedover = ?, accomprice = ?" + 
            ...
            try {
                ...
                ps.setObject(11, getOperatorfault());
                ps.setObject(12, getOperatorId());
                ps.setObject(13, getXconsumeId());
                ps.setObject(14, getKm2site1way());
                ps.setObject(15, getHoursonjob());
                ps.setObject(16, getTimeleft());
                ps.setObject(17, getTimeback());
                ps.setObject(18, getStayedover());
                ps.setObject(19, getAccomprice());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xbreakdown_id,breakdowndate,xmachine_id,xsite_id,reportedto_id,reportedby_id,attendedby_id,vehicle_id,repairdate,repaired,description,operatorfault,operator_id,xconsume_id,km2site1way,hoursonjob,timeleft,timeback,stayedover,accomprice FROM xbreakdown " +
    ...
    public Object[] getAsRow() {
        ...
        columnValues[11] = getOperatorfault();
        columnValues[12] = getOperatorId();
        columnValues[13] = getXconsumeId();
        columnValues[14] = getKm2site1way();
        columnValues[15] = getHoursonjob();
        columnValues[16] = getTimeleft();
        columnValues[17] = getTimeback();
        columnValues[18] = getStayedover();
        columnValues[19] = getAccomprice();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setOperatorfault(Integer.parseInt(flds[11]));
        } catch(NumberFormatException ne) {
            setOperatorfault(null);
        }
        try {
            setOperatorId(Integer.parseInt(flds[12]));
        } catch(NumberFormatException ne) {
            setOperatorId(null);
        }
        try {
            setXconsumeId(Integer.parseInt(flds[13]));
        } catch(NumberFormatException ne) {
            setXconsumeId(null);
        }
        try {
            setKm2site1way(Integer.parseInt(flds[14]));
        } catch(NumberFormatException ne) {
            setKm2site1way(null);
        }
        try {
            setHoursonjob(Integer.parseInt(flds[15]));
        } catch(NumberFormatException ne) {
            setHoursonjob(null);
        }
        try {
            setTimeleft(Integer.parseInt(flds[16]));
        } catch(NumberFormatException ne) {
            setTimeleft(null);
        }
        try {
            setTimeback(Integer.parseInt(flds[17]));
        } catch(NumberFormatException ne) {
            setTimeback(null);
        }
        try {
            setStayedover(Integer.parseInt(flds[18]));
        } catch(NumberFormatException ne) {
            setStayedover(null);
        }
        try {
            setAccomprice(Integer.parseInt(flds[19]));
        } catch(NumberFormatException ne) {
            setAccomprice(null);
        }
    }
