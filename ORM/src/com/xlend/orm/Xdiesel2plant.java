...
public class Xdiesel2plant extends DbObject  {
    ...
    public Xdiesel2plant(Connection connection) {
        ...
        setColumnNames(new String[]{"xdiesel2plant_id", "xdieselcart_id", "start_date", "driver_id"});
    }

    public Xdiesel2plant(Connection connection, Integer xdiesel2plantId, Integer xdieselcartId, Date startDate, Integer driverId) {
        super(connection, "xdiesel2plant", "xdiesel2plant_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xdiesel2plant_id,xdieselcart_id,start_date,driver_id FROM xdiesel2plant WHERE xdiesel2plant_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xdiesel2plant.setStartDate(rs.getDate(3));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xdiesel2plant ("+(getXdiesel2plantId().intValue()!=0?"xdiesel2plant_id,":"")+"xdieselcart_id,start_date,driver_id) values("+(getXdiesel2plantId().intValue()!=0?"?,":"")+"?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xdiesel2plant_id,xdieselcart_id,start_date,driver_id FROM xdiesel2plant " +
