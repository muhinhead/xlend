...
public class Xdiesel2plant extends DbObject  {
    ...
    public Xdiesel2plant(Connection connection) {
        ...
        setColumnNames(new String[]{"xdiesel2plant_id", "xsupplier_id", "xdieselcart_id", "driver_id"});
    }

    public Xdiesel2plant(Connection connection, Integer xdiesel2plantId, Integer xsupplierId, Integer xdieselcartId, Integer driverId) {
        super(connection, "xdiesel2plant", "xdiesel2plant_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xdiesel2plant_id,xsupplier_id,xdieselcart_id,driver_id FROM xdiesel2plant WHERE xdiesel2plant_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xdiesel2plant.setXsupplierId(new Integer(rs.getInt(2)));
                xdiesel2plant.setXdieselcartId(new Integer(rs.getInt(3)));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xdiesel2plant ("+(getXdiesel2plantId().intValue()!=0?"xdiesel2plant_id,":"")+"xsupplier_id,xdieselcart_id,driver_id) values("+(getXdiesel2plantId().intValue()!=0?"?,":"")+"?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    ...
                    "SET xsupplier_id = ?, xdieselcart_id = ?, driver_id = ?" + 
                    " WHERE xdiesel2plant_id = " + getXdiesel2plantId();
            try {
                ps = getConnection().prepareStatement(stmt);
                ps.setObject(1, getXsupplierId());
                ps.setObject(2, getXdieselcartId());
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xdiesel2plant_id,xsupplier_id,xdieselcart_id,driver_id FROM xdiesel2plant " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xdiesel2plant(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),new Integer(rs.getInt(3)),new Integer(rs.getInt(4))));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public void setXsupplierId(Integer xsupplierId) throws SQLException, ForeignKeyViolationException {
        if (xsupplierId!=null && !Xsupplier.exists(getConnection(),"xsupplier_id = " + xsupplierId)) {
            throw new ForeignKeyViolationException("Can't set xsupplier_id, foreign key violation: xdiesel2plant_xsupplier_fk");
        }
    ...
    public Object[] getAsRow() {
        ...
        columnValues[2] = getXdieselcartId();
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setXdieselcartId(Integer.parseInt(flds[2]));
        } catch(NumberFormatException ne) {
