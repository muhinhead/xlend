 ...
 * @author Nick Mukhin
 */
public class PayFromGrid extends GeneralGridPanel {
    ...
    public PayFromGrid(IMessageSender exchanger) throws RemoteException {
        super(exchanger, Selects.SELECT_FROM_PAYFROM, maxWidths, false);
    }
