...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                xemployee.setEmploymentStart(rs.getDate(40));
                xemployee.setManagement(new Integer(rs.getInt(41)));
                xemployee.setClockNumonly(new Integer(rs.getInt(42)));
                xemployee.setNotes(rs.getString(43));
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            try {
                ...
                ps.setObject(39, getEmploymentStart());
                ps.setObject(40, getManagement());
                ps.setObject(41, getClockNumonly());
                ps.setObject(42, getNotes());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public Object[] getAsRow() {
        ...
        columnValues[39] = getEmploymentStart();
        columnValues[40] = getManagement();
        columnValues[41] = getClockNumonly();
        columnValues[42] = getNotes();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        setEmploymentStart(toDate(flds[39]));
        try {
            setManagement(Integer.parseInt(flds[40]));
        } catch(NumberFormatException ne) {
            setManagement(null);
        }
        try {
            setClockNumonly(Integer.parseInt(flds[41]));
        } catch(NumberFormatException ne) {
