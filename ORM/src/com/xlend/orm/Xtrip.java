...
public class Xtrip extends DbObject  {
    ...
    public Xtrip(Connection connection) {
        ...
        setColumnNames(new String[]{"xtrip_id", "xlowbed_id", "trip_date", "fromsite_id", "insite_id", "tosite_id", "driver_id", "assistant_id", "trip_type", "distance_empty", "distance_loaded", "machine_id", "withmachine_id", "is_copmplete"});
    }

    public Xtrip(Connection connection, Integer xtripId, Integer xlowbedId, Date tripDate, Integer fromsiteId, Integer insiteId, Integer tositeId, Integer driverId, Integer assistantId, Integer tripType, Integer distanceEmpty, Integer distanceLoaded, Integer machineId, Integer withmachineId, Integer isCopmplete) {
        super(connection, "xtrip", "xtrip_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xtrip_id,xlowbed_id,trip_date,fromsite_id,insite_id,tosite_id,driver_id,assistant_id,trip_type,distance_empty,distance_loaded,machine_id,withmachine_id,is_copmplete FROM xtrip WHERE xtrip_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xtrip ("+(getXtripId().intValue()!=0?"xtrip_id,":"")+"xlowbed_id,trip_date,fromsite_id,insite_id,tosite_id,driver_id,assistant_id,trip_type,distance_empty,distance_loaded,machine_id,withmachine_id,is_copmplete) values("+(getXtripId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xtrip " +
                    "SET xlowbed_id = ?, trip_date = ?, fromsite_id = ?, insite_id = ?, tosite_id = ?, driver_id = ?, assistant_id = ?, trip_type = ?, distance_empty = ?, distance_loaded = ?, machine_id = ?, withmachine_id = ?, is_copmplete = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xtrip_id,xlowbed_id,trip_date,fromsite_id,insite_id,tosite_id,driver_id,assistant_id,trip_type,distance_empty,distance_loaded,machine_id,withmachine_id,is_copmplete FROM xtrip " +
