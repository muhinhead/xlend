// Generated by com.xlend.orm.tools.dbgen.DbGenerator.class at Tue May 08 15:05:00 EEST 2012
...
public class Xloans extends DbObject  {
    ...
    public Xloans(Connection connection) {
        ...
        setColumnNames(new String[]{"xloans_id", "loandate", "is_loan", "is_advance", "is_transport", "requestedby_id", "authorizedby_id", "issueddate", "deductstartdate", "amount", "deduction", "deducttime", "is_signed", "represent_id"});
    }

    public Xloans(Connection connection, Integer xloansId, Date loandate, Integer isLoan, Integer isAdvance, Integer isTransport, Integer requestedbyId, Integer authorizedbyId, Date issueddate, Date deductstartdate, Double amount, Double deduction, Integer deducttime, Integer isSigned, Integer representId) {
        super(connection, "xloans", "xloans_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xloans_id,loandate,is_loan,is_advance,is_transport,requestedby_id,authorizedby_id,issueddate,deductstartdate,amount,deduction,deducttime,is_signed,represent_id FROM xloans WHERE xloans_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xloans.setRepresentId(new Integer(rs.getInt(14)));
                xloans.setNew(false);
            }
        } finally {
            try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xloans ("+(getXloansId().intValue()!=0?"xloans_id,":"")+"loandate,is_loan,is_advance,is_transport,requestedby_id,authorizedby_id,issueddate,deductstartdate,amount,deduction,deducttime,is_signed,represent_id) values("+(getXloansId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xloans " +
                    "SET loandate = ?, is_loan = ?, is_advance = ?, is_transport = ?, requestedby_id = ?, authorizedby_id = ?, issueddate = ?, deductstartdate = ?, amount = ?, deduction = ?, deducttime = ?, is_signed = ?, represent_id = ?" + 
            ...
            try {
                ...
                ps.setObject(13, getRepresentId());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xloans_id,loandate,is_loan,is_advance,is_transport,requestedby_id,authorizedby_id,issueddate,deductstartdate,amount,deduction,deducttime,is_signed,represent_id FROM xloans " +
    ...
    public void setRepresentId(Integer representId) throws SQLException, ForeignKeyViolationException {
        if (representId!=null && !Xemployee.exists(getConnection(),"xemployee_id = " + representId)) {
            throw new ForeignKeyViolationException("Can't set represent_id, foreign key violation: xloans_xemployee_fk3");
        }
        setWasChanged(this.representId != null && !this.representId.equals(representId));
        this.representId = representId;
    }
    public Object[] getAsRow() {
        ...
        columnValues[13] = getRepresentId();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setRepresentId(Integer.parseInt(flds[13]));
        } catch(NumberFormatException ne) {
            setRepresentId(null);
        }
    }
