...
public class Xparts extends DbObject  {
    ...
    public Xparts(Connection connection) {
        ...
        setColumnNames(new String[]{"xparts_id", "partnumber", "description", "xmachtype_id", "xpartcategory_id", "whatfor"});
    }

    public Xparts(Connection connection, Integer xpartsId, String partnumber, String description, Integer xmachtypeId, Integer xpartcategoryId, String whatfor) {
        super(connection, "xparts", "xparts_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xparts_id,partnumber,description,xmachtype_id,xpartcategory_id,whatfor FROM xparts WHERE xparts_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xparts.setWhatfor(rs.getString(6));
                xparts.setNew(false);
            }
        } finally {
            try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xparts ("+(getXpartsId().intValue()!=0?"xparts_id,":"")+"partnumber,description,xmachtype_id,xpartcategory_id,whatfor) values("+(getXpartsId().intValue()!=0?"?,":"")+"?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xparts " +
                    "SET partnumber = ?, description = ?, xmachtype_id = ?, xpartcategory_id = ?, whatfor = ?" + 
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xparts_id,partnumber,description,xmachtype_id,xpartcategory_id,whatfor FROM xparts " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Xparts(con,new Integer(rs.getInt(1)),rs.getString(2),rs.getString(3),new Integer(rs.getInt(4)),new Integer(rs.getInt(5)),rs.getString(6)));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public void setWhatfor(String whatfor) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.whatfor != null && !this.whatfor.equals(whatfor));
        this.whatfor = whatfor;
    }
