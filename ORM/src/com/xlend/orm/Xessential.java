...
public class Xessential extends DbObject  {
    ...
    public Xessential(Connection connection) {
        ...
        setColumnNames(new String[]{"xessential_id", "out_date", "return_date", "redress_date", "redress_amt", "essential", "driver_id", "issued_by", "received_by"});
    }

    public Xessential(Connection connection, Integer xessentialId, Date outDate, Date returnDate, Date redressDate, Double redressAmt, String essential, Integer driverId, Integer issuedBy, Integer receivedBy) {
        super(connection, "xessential", "xessential_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT xessential_id,out_date,return_date,redress_date,redress_amt,essential,driver_id,issued_by,received_by FROM xessential WHERE xessential_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                xessential.setOutDate(rs.getDate(2));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO xessential ("+(getXessentialId().intValue()!=0?"xessential_id,":"")+"out_date,return_date,redress_date,redress_amt,essential,driver_id,issued_by,received_by) values("+(getXessentialId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE xessential " +
                    "SET out_date = ?, return_date = ?, redress_date = ?, redress_amt = ?, essential = ?, driver_id = ?, issued_by = ?, received_by = ?" + 
                    " WHERE xessential_id = " + getXessentialId();
            try {
                ps = getConnection().prepareStatement(stmt);
                ps.setObject(1, getOutDate());
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT xessential_id,out_date,return_date,redress_date,redress_amt,essential,driver_id,issued_by,received_by FROM xessential " +
    ...
    public void setOutDate(Date outDate) throws SQLException, ForeignKeyViolationException {
        setWasChanged(this.outDate != null && !this.outDate.equals(outDate));
        this.outDate = outDate;
    }
