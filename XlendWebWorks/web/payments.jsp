<%-- 
    Document   : payments
    Created on : 09.02.2014, 16:33:24
    Author     : Nick Mukhin
--%>

<%@page import="java.sql.Connection"%>
<%@page import="com.xlend.util.ImagePanel"%>
<%@page import="com.xlend.orm.Xpayment"%>
...
<html>
    ...
    <% final String imgFile = "tab_payments.png";%>
    <% ImagePanel maxImg = new ImagePanel(Util.loadImage(imgFile, getServletContext()));%>
    <% DbObject[] payments = Xpayment.load(connection, null, null);%>
    <head>
        <style type="text/css">
            <!--
...
<!--            <div  id="my-div" style="position:absolute; left: 577px; top: 8px;">
        ...
        <h3>List of <%=payments.length%> payments</h3>
        <form>
            <%=Util.showTable(Selects.SELECT_FROM_PAYMENTS, connection, null)%>
        </form>
    </body>
