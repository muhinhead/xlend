...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        {// delete cascade from xemployeepenalty
            Xemployeepenalty[] records = (Xemployeepenalty[])Xemployeepenalty.load(getConnection(),"xincidents_id = " + getXincidentsId(),null);
            for (int i = 0; i<records.length; i++) {
                Xemployeepenalty xemployeepenalty = records[i];
                xemployeepenalty.delete();
            }
        }
        PreparedStatement ps = null;
        String stmt =
