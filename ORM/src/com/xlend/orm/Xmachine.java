...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        if (Xtripestablish.exists(getConnection(),"xmachine_id = " + getXmachineId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xtripestablish_xmachine_fk");
        }
        if (Xtripexchange.exists(getConnection(),"withmachine_id = " + getXmachineId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xtripexchange_xmachine_fk2");
        }
        ...
        if (Xtripexchange.exists(getConnection(),"machine_id = " + getXmachineId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xtripexchange_xmachine_fk");
        }
        ...
        if (Xtripmoving.exists(getConnection(),"xmachine_id = " + getXmachineId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: xtripmoving_xmachine_fk");
        }
        ...
        {// delete cascade from xmachineonsite
            Xmachineonsite[] records = (Xmachineonsite[])Xmachineonsite.load(getConnection(),"xmachine_id = " + getXmachineId(),null);
            for (int i = 0; i<records.length; i++) {
                Xmachineonsite xmachineonsite = records[i];
                xmachineonsite.delete();
            }
        }
