<%-- 
    Document   : sites_sitediary
    Created on : 30.03.2013, 9:27:57
    Author     : Admin
--%>
...
<!--            <div id="my-div" style="position:absolute; left: 350px; top: 8px;">
            ...
            <img src="images/tab_site_diary.png" alt="Tabs" width="<%=maxImg.getWidth()%>" height="<%=maxImg.getHeight()%>"/>
        </div>
        ...
        <form>
            <%=Util.showTable(Selects.SELECT_FROM_SITE_DIARY, connection, null)%>
        </form>
    </body>
</html>
